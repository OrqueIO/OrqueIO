...
import static io.orqueio.bpm.engine.impl.bpmn.helper.CompensationUtil.SIGNAL_COMPENSATION_DONE;
import static io.orqueio.bpm.engine.impl.pvm.runtime.ActivityInstanceState.ENDING;
...
import io.orqueio.bpm.engine.impl.form.FormPropertyHelper;
...
import io.orqueio.bpm.engine.impl.incident.IncidentHandling;
import io.orqueio.bpm.engine.impl.persistence.entity.DelayedVariableEvent;
...
import io.orqueio.bpm.engine.impl.pvm.delegate.ModificationObserverBehavior;
...
import io.orqueio.bpm.engine.impl.tree.ExecutionWalker;
import io.orqueio.bpm.engine.impl.tree.FlowScopeWalker;
import io.orqueio.bpm.engine.impl.tree.LeafActivityInstanceExecutionCollector;
import io.orqueio.bpm.engine.impl.tree.ReferenceWalker;
import io.orqueio.bpm.engine.impl.tree.ScopeCollector;
import io.orqueio.bpm.engine.impl.tree.ScopeExecutionCollector;
...
public abstract class PvmExecutionImpl extends CoreExecution implements
   ...
   * check  https://github.com/orqueio/orqueio-bpm-platform/issues/3979
   */
