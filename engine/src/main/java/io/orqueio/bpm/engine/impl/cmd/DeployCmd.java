...
import io.orqueio.bpm.engine.impl.persistence.entity.ProcessApplicationDeploymentImpl;
...
import io.orqueio.bpm.engine.impl.repository.CandidateDeploymentImpl;
...
import io.orqueio.bpm.engine.repository.CandidateDeployment;
...
public class DeployCmd implements Command<DeploymentWithDefinitions>, Serializable {
  ...
  protected void acquireExclusiveLock(CommandContext commandContext) {
    if (commandContext.getProcessEngineConfiguration().isDeploymentLockUsed()) {
      ...
      // in a multi-node cluster. See also https://app.orqueio.com/jira/browse/CAM-2128
