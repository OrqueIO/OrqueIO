...
function OrqueioClient(config) {
  ...
  this.HttpClient = config.HttpClient || OrqueioClient.HttpClient;
 ...
 * @memberof CamSDK.client.OrqueioClient
 * @name HttpClient
 * @type {CamSDK.client.HttpClient}
 */
OrqueioClient.HttpClient = require('./http-client');

// provide an isolated scope
(function(proto) {
  /**
   * configuration storage
   * @memberof CamSDK.client.OrqueioClient.prototype
   * @name  config
   * @type {Object}
   */
  proto.config = {};
...
})(OrqueioClient.prototype);

module.exports = OrqueioClient;
