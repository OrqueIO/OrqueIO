...
import io.orqueio.bpm.engine.impl.cmmn.cmd.StateTransitionCaseExecutionCmd;
...
public class CompetingParentCompletionTest {
  ...
  @Deployment(resources = {"io/orqueio/bpm/engine/test/concurrency/CompetingParentCompletionTest.testComplete.cmmn"})
  @Test
  ...
  @Deployment(resources = {"io/orqueio/bpm/engine/test/concurrency/CompetingParentCompletionTest.testDisable.cmmn"})
  @Test
  ...
  @Deployment(resources = {"io/orqueio/bpm/engine/test/concurrency/CompetingParentCompletionTest.testTerminate.cmmn"})
  @Test
