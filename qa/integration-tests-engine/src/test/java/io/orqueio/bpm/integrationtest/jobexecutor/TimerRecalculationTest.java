...
import io.orqueio.bpm.integrationtest.jobexecutor.beans.TimerExpressionBean;
...
public class TimerRecalculationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    WebArchive archive = initWebArchiveDeployment()
            .addAsResource("io/orqueio/bpm/integrationtest/jobexecutor/TimerRecalculation.bpmn20.xml")
