...
/**
 * <p>Bootstrap for the OrqueIO using a singleton EJB</p>
 *
 * @author Daniel Meyer
 */
@Startup
...
public class EjbBpmPlatformBootstrap {
  ...
  protected void start() {
    ...
    containerDelegate.getServiceContainer().createDeploymentOperation("deploying OrqueIO")
    ...
    LOGGER.log(Level.INFO, "OrqueIO started successfully.");
  }
  ...
  protected void stop() {
    ...
    containerDelegate.getServiceContainer().createUndeploymentOperation("undeploying OrqueIO")
    ...
    LOGGER.log(Level.INFO, "OrqueIO stopped.");
