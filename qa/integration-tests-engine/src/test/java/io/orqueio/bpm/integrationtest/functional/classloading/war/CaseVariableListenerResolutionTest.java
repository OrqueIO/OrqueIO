...
import io.orqueio.bpm.integrationtest.functional.classloading.beans.ExampleCaseVariableListener;
...
public class CaseVariableListenerResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("io/orqueio/bpm/integrationtest/functional/classloading/CaseVariableListenerResolutionTest.cmmn");
  }
  ...
  public void testResolveCaseExecutionListenerClass() {
    ...
    try {
      Class.forName("io.orqueio.bpm.integrationtest.functional.classloading.beans.ExampleCaseVariableListener");
