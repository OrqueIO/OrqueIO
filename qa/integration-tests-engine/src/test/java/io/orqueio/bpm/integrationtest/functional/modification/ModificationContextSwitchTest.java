 ...
 */
package io.orqueio.bpm.integrationtest.functional.modification;

import io.orqueio.bpm.engine.runtime.ProcessInstanceModificationInstantiationBuilder;
import io.orqueio.bpm.integrationtest.functional.modification.beans.ExampleDelegate;
...
public class ModificationContextSwitchTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("io/orqueio/bpm/integrationtest/functional/modification/ModificationContextSwitchTest.testModificationClassloading.bpmn20.xml");
  }
