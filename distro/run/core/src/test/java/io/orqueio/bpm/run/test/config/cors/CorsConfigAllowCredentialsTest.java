 ...
 *
 * @see https://jira.orqueio.com/browse/CAM-11290
 */
@ActiveProfiles(profiles = { "test-cors-enabled" }, inheritProfiles = true)
@TestPropertySource(properties = {
    OrqueioBpmRunCorsProperty.PREFIX + ".allowed-origins=http://other.origin:8081",
    OrqueioBpmRunCorsProperty.PREFIX + ".allow-credentials=true"})
