 ...
 */
package io.orqueio.bpm.engine.spring.test.scripttask;
...
@ContextConfiguration(locations = {
    "classpath:io/orqueio/bpm/engine/spring/test/scripttask/ScriptTaskLimitedBeansTest-applicationContext.xml" })
