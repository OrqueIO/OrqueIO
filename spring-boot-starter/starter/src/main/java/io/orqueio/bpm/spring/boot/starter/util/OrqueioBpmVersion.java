...
import static io.orqueio.bpm.spring.boot.starter.property.OrqueioBpmProperties.PREFIX;

/**
 * Return the full version string of the present Orqueio codebase, or
 * {@code null} if it cannot be determined.
 * <p/>
 * return the version of Orqueio or {@code null}
 *
 * @see Package#getImplementationVersion()
 */
public class OrqueioBpmVersion implements Supplier<String> {
  ...
  public OrqueioBpmVersion() {
    this(ProcessEngine.class.getPackage());
  }

  OrqueioBpmVersion(final Package pkg) {
