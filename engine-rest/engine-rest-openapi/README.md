...
`docsUrl="https://docs.orqueio.io/manual/${docsVersion}"
...
```
  "description": "Submits a list of modification instructions to change a process instance's execution state.
                  ...
                  * Canceling an activity instance, transition instance, or all instances (activity or transition) for an activity
                  ...
                  The exact semantics of modification can be read about in the [User guide](https://docs.orqueio.io/manual/develop/user-guide/process-engine/process-instance-modification/)."
```
...
```
    <@lib.property
        ...
        description = "Restrict to instances that were started before the given date.
                       By default (https://docs.orqueio.io/manual/${docsVersion}/reference/rest/overview/date-format/),
                       the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., 2013-01-23T14:42:45.000+0200." />
```
That will improve the clients that are generated from the OpenAPI documentation. **Note:** When using a 'date-time' in a 'GET' request (as URL parameter), it is important to use proper URL encoding as described in the [Date Format Overview](https://docs.orqueio.io/manual/develop/reference/rest/overview/date-format/)
