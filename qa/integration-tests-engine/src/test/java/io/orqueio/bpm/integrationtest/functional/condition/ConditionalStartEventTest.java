 ...
 */
package io.orqueio.bpm.integrationtest.functional.condition;
...
import io.orqueio.bpm.integrationtest.functional.condition.bean.ConditionalBean;
...
public class ConditionalStartEventTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeployment() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("io/orqueio/bpm/integrationtest/functional/condition/ConditionalStartEventTest.bpmn20.xml");
  }
