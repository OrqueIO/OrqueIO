...
public class OrqueioBpmRunDeploymentProperties {

  public static final String PREFIX = OrqueioBpmRunProperties.PREFIX + ".deployment";
  ...
  public String toString() {
    return "OrqueioBpmRunDeploymentProperties[" + "deployChangedOnly=" + deployChangedOnly + ']';
  }
}
