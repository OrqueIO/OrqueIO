...
require('orqueio-commons-ui/vendor/bootstrap');
...
var moment = require('orqueio-commons-ui/vendor/moment');
var events = require('events');
var lodash = require('orqueio-commons-ui/vendor/lodash');
...
export function exposePackages(container) {
  ...
  container.jquery = $;
  container['orqueio-commons-ui'] = commons;
  container['orqueio-bpm-sdk-js'] = sdk;
