...
/**
 * <p>Class providing static methods returning all the resource classes provided by OrqueIO.</p>
 *
 * @author Daniel Meyer
 *
 */
public class CamundaRestResources {
  ...
  /**
   * Returns a set containing all resource classes provided by OrqueIO.
