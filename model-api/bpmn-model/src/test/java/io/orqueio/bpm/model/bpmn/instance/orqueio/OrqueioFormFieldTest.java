 ...
 */
public class OrqueioFormFieldTest extends BpmnModelElementInstanceTest {
  ...
  public Collection<ChildElementAssumption> getChildElementAssumptions() {
    return Arrays.asList(
      new ChildElementAssumption(ORQUEIO_NS, OrqueioProperties.class, 0, 1),
      new ChildElementAssumption(ORQUEIO_NS, OrqueioValidation.class, 0, 1),
  ...
  public Collection<AttributeAssumption> getAttributesAssumptions() {
    return Arrays.asList(
      ...
      new AttributeAssumption(ORQUEIO_NS, "label"),
      new AttributeAssumption(ORQUEIO_NS, "type"),
      new AttributeAssumption(ORQUEIO_NS, "datePattern"),
      new AttributeAssumption(ORQUEIO_NS, "defaultValue")
    );
  }
}
