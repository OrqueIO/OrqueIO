...
This project provides Spring Boot starters that allow you to integrate the OrqueIO into your Spring Boot applications.
...
Starting from version 2.3.0 it was adopted as part of the OrqueIO.
