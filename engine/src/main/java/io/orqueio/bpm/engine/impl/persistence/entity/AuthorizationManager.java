...
import static io.orqueio.bpm.engine.authorization.Permissions.READ_TASK;
...
import static io.orqueio.bpm.engine.authorization.ProcessDefinitionPermissions.READ_INSTANCE_VARIABLE;
import static io.orqueio.bpm.engine.authorization.Resources.AUTHORIZATION;
import static io.orqueio.bpm.engine.authorization.Resources.BATCH;
...
import static io.orqueio.bpm.engine.authorization.Resources.DEPLOYMENT;
...
import static io.orqueio.bpm.engine.authorization.TaskPermissions.READ_VARIABLE;
...
import io.orqueio.bpm.engine.impl.AuthorizationQueryImpl;
import io.orqueio.bpm.engine.impl.DeploymentQueryImpl;
import io.orqueio.bpm.engine.impl.DeploymentStatisticsQueryImpl;
import io.orqueio.bpm.engine.impl.EventSubscriptionQueryImpl;
import io.orqueio.bpm.engine.impl.ExternalTaskQueryImpl;
import io.orqueio.bpm.engine.impl.HistoricActivityInstanceQueryImpl;
...
import io.orqueio.bpm.engine.impl.HistoricExternalTaskLogQueryImpl;
import io.orqueio.bpm.engine.impl.HistoricIdentityLinkLogQueryImpl;
import io.orqueio.bpm.engine.impl.HistoricIncidentQueryImpl;
import io.orqueio.bpm.engine.impl.HistoricJobLogQueryImpl;
...
import io.orqueio.bpm.engine.impl.HistoricVariableInstanceQueryImpl;
import io.orqueio.bpm.engine.impl.IncidentQueryImpl;
...
import io.orqueio.bpm.engine.impl.UserOperationLogQueryImpl;
...
import io.orqueio.bpm.engine.impl.batch.history.HistoricBatchQueryImpl;
import io.orqueio.bpm.engine.impl.cfg.CommandChecker;
import io.orqueio.bpm.engine.impl.context.Context;
import io.orqueio.bpm.engine.impl.db.AuthorizationCheck;
import io.orqueio.bpm.engine.impl.db.CompositePermissionCheck;
...
import io.orqueio.bpm.engine.impl.db.PermissionCheckBuilder;
...
import io.orqueio.bpm.engine.impl.persistence.entity.util.AuthManagerUtil;
import io.orqueio.bpm.engine.impl.persistence.entity.util.AuthManagerUtil.VariablePermissions;
import io.orqueio.bpm.engine.impl.util.ResourceTypeUtil;
