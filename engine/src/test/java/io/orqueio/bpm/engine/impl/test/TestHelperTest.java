...
public class TestHelperTest {
  ...
  public void shouldGetPublicMethod() throws NoSuchMethodException {
    ...
    assertThat(methodName.toString()).isEqualTo("public void io.orqueio.bpm.engine.impl.test.TestHelperTest$SomeTestClass.testSomethingWithPublicAccessor()");
  }
  ...
  public void shouldGetPackagePrivateMethod() throws NoSuchMethodException {
    ...
    assertThat(methodName.toString()).isEqualTo("void io.orqueio.bpm.engine.impl.test.TestHelperTest$SomeTestClass.testSomethingWithPackagePrivateAccessor()");
  }
  ...
  public void shouldGetProtectedMethod() throws NoSuchMethodException {
    ...
    assertThat(methodName.toString()).isEqualTo("protected void io.orqueio.bpm.engine.impl.test.TestHelperTest$SomeTestClass.testSomethingWithProtected()");
  }
