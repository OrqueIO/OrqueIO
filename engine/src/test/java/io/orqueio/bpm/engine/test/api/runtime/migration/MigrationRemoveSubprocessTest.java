...
import io.orqueio.bpm.engine.test.bpmn.multiinstance.DelegateEvent;
import io.orqueio.bpm.engine.test.bpmn.multiinstance.DelegateExecutionListener;
import io.orqueio.bpm.engine.test.util.MigrationPlanValidationReportAssert;
...
public class MigrationRemoveSubprocessTest {
  ...
  public void testEndListenerInvocationForRemovedScope() {
    ...
    ProcessDefinition sourceProcessDefinition = testHelper.deployAndGetDefinition(modify(ProcessModels.SUBPROCESS_PROCESS)
      ...
      .orqueioExecutionListenerClass(ExecutionListener.EVENTNAME_END, DelegateExecutionListener.class.getName())
      .done()
    );
    ProcessDefinition targetProcessDefinition = testHelper.deployAndGetDefinition(ProcessModels.ONE_TASK_PROCESS);
