...
import io.orqueio.bpm.spring.boot.starter.spin.OrqueioJacksonFormatConfiguratorJSR310;
import io.orqueio.bpm.spring.boot.starter.spin.OrqueioJacksonFormatConfiguratorJdk8;
import io.orqueio.bpm.spring.boot.starter.spin.OrqueioJacksonFormatConfiguratorParameterNames;
...
@Configuration
public class OrqueioBpmPluginConfiguration {

  /*
     When `orqueio-spin-dataformat-all` is used as a dependency,
     SpinDataFormatConfigurationJSR310, SpinDataFormatConfigurationParameterNames
     and SpinDataFormatConfigurationJdk8 are not used. The `orqueio-spin-dataformat-all`
  ...
  */
  ...
  static class SpinDataFormatConfigurationJSR310 {
    ...
    public static OrqueioJacksonFormatConfiguratorJSR310 spinDataFormatConfiguratorJSR310() {
      return new OrqueioJacksonFormatConfiguratorJSR310();
    }
  ...
  static class SpinDataFormatConfigurationParameterNames {
    ...
    public static OrqueioJacksonFormatConfiguratorParameterNames spinDataFormatConfiguratorParameterNames() {
      return new OrqueioJacksonFormatConfiguratorParameterNames();
    }
  ...
  static class SpinDataFormatConfigurationJdk8 {
    ...
    public static OrqueioJacksonFormatConfiguratorJdk8 spinDataFormatConfiguratorJdk8() {
      return new OrqueioJacksonFormatConfiguratorJdk8();
    }
  ...
  /*
    ...
    For more details: https://jira.orqueio.com/browse/CAM-9043
   */
