...
public class EventNotificationTest extends CdiProcessEngineTestCase {
  ...
  @Test
  @Deployment(resources = {"io/orqueio/bpm/engine/cdi/test/impl/event/EventNotificationTest.process1.bpmn20.xml"})
  ...
  @Deployment(resources = {
      "io/orqueio/bpm/engine/cdi/test/impl/event/EventNotificationTest.process1.bpmn20.xml",
      "io/orqueio/bpm/engine/cdi/test/impl/event/EventNotificationTest.process2.bpmn20.xml" })
