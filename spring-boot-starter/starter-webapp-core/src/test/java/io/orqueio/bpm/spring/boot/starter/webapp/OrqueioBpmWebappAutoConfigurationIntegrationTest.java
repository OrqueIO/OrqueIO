...
public class OrqueioBpmWebappAutoConfigurationIntegrationTest {

  private String bpmEnabled = OrqueioBpmProperties.PREFIX + ".enabled=true";

  private String bpmDisabled = OrqueioBpmProperties.PREFIX + ".enabled=false";
  ...
  @Before
  public void setUp() {
    AutoConfigurations autoConfigurationsUnderTest = AutoConfigurations.of(OrqueioBpmAutoConfiguration.class, OrqueioBpmWebappAutoConfiguration.class);
  ...
  public void test_bpmIsNotDisabled_and_webappIsNotDisabled_shouldInitWebapp() {
    contextRunner.run(context -> {
      ...
      assertThat(context).hasSingleBean(OrqueioBpmWebappInitializer.class);
  ...
  public void test_bpmIsDisabled_and_webappIsNotDisabled_shouldNotInitWebapp() {
    contextRunner.withPropertyValues(bpmDisabled).run(context -> {
      assertThat(context).hasNotFailed();
      assertThat(context).doesNotHaveBean(OrqueioBpmWebappInitializer.class);
