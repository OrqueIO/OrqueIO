...
var ProcessInstance = AbstractClientResource.extend(
  ...
  /** @lends  CamSDK.client.resource.ProcessInstance */
  {
     ...
     * @see http://docs.orqueio.io/api-references/rest/#process-instance-modify-process-instance-execution-state-method
     *
     * @param  {Object}           params
     ...
     *
     * @see https://docs.orqueio.io/manual/latest/reference/rest/process-instance/post-delete/
     *
     ...
     *
     * @see https://docs.orqueio.io/manual/latest/reference/rest/process-instance/post-delete-historic-query-based/
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     *
     ...
     *
     * @see https://docs.orqueio.io/manual/latest/reference/rest/process-instance/post-set-job-retries
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     *
     ...
     *
     * @see https://docs.orqueio.io/manual/latest/reference/rest/process-instance/post-set-job-retries-historic-query-based
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     *
     ...
     *
     * @see https://docs.orqueio.io/manual/latest/reference/rest/process-instance/post-activate-suspend-in-batch/
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     */
     ...
     *
     * @see https://docs.orqueio.io/manual/latest/reference/rest/process-instance/post-set-variables-async/
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     */
     ...
     *
     * @see https://docs.orqueio.io/manual/latest/reference/rest/process-instance/post-message-async/
     *
     * @param   {Object}            payload
     * @param   {requestCallback}   done
     */
     ...
     *
     * @see http://docs.orqueio.io/manual/develop/reference/rest/process-instance/variables/put-variable/
     *
     * @param   {uuid}              id
     * @param   {Object}            params
     * @param   {requestCallback}   done
