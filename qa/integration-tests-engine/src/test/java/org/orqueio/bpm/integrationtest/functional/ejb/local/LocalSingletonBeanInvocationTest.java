...
import io.orqueio.bpm.integrationtest.functional.ejb.local.bean.BusinessInterface;
import io.orqueio.bpm.integrationtest.functional.ejb.local.bean.LocalSingletonBean;
import io.orqueio.bpm.integrationtest.functional.ejb.local.bean.LocalSingletonBeanClientDelegateBean;
...
public class LocalSingletonBeanInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("io/orqueio/bpm/integrationtest/functional/ejb/local/LocalSingletonBeanInvocationTest.testInvokeBean.bpmn20.xml")
      .addAsWebInfResource("io/orqueio/bpm/integrationtest/functional/ejb/local/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
  }
