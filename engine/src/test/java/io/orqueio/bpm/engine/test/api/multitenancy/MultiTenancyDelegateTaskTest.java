...
import io.orqueio.bpm.engine.test.api.delegate.AssertingTaskListener;
import io.orqueio.bpm.engine.test.api.delegate.AssertingTaskListener.DelegateTaskAsserter;
...
public class MultiTenancyDelegateTaskTest extends PluggableProcessEngineTest {
  ...
  protected static final String BPMN = "io/orqueio/bpm/engine/test/api/multitenancy/taskListener.bpmn";
