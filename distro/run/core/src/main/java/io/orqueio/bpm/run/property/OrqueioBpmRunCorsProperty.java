...
public class OrqueioBpmRunCorsProperty {

  public static final String PREFIX = OrqueioBpmRunProperties.PREFIX + ".cors";
  ...
  public OrqueioBpmRunCorsProperty() {
  ...
  public String toString() {
    return "OrqueioBpmRunCorsProperty [" +
        "enabled=" + enabled +
