...
import io.orqueio.bpm.integrationtest.functional.classloading.beans.ExampleCaseExecutionListener;
...
public class CaseExecutionListenerResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("io/orqueio/bpm/integrationtest/functional/classloading/CaseExecutionListenerResolutionTest.cmmn");
  }
  ...
  public void testResolveCaseExecutionListenerClass() {
    ...
    try {
      Class.forName("io.orqueio.bpm.integrationtest.functional.classloading.beans.ExampleCaseExecutionListener");
