...
/**
 * The BPMN validation orqueio extension element
 *
 * @author Sebastian Menski
 */
public class OrqueioValidationImpl extends BpmnModelElementInstanceImpl implements OrqueioValidation {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ...
    orqueioConstraintCollection = sequenceBuilder.elementCollection(OrqueioConstraint.class)
      .build();

    typeBuilder.build();
  }

  public OrqueioValidationImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public Collection<OrqueioConstraint> getOrqueioConstraints() {
    return orqueioConstraintCollection.get(this);
  }
}
