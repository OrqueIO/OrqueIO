...
import io.orqueio.bpm.integrationtest.functional.el.beans.ResolveFormDataBean;
...
public class ElResolveTaskFormDataTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("io/orqueio/bpm/integrationtest/functional/el/elTaskFormProcessWithFormData.bpmn20.xml");
  }
