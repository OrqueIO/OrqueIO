...
public class TaskDefinition {
  ...
  public Expression getOrqueioFormDefinitionKey() {
    return formDefinition.getOrqueioFormDefinitionKey();
  }

  public String getOrqueioFormDefinitionBinding() {
    return formDefinition.getOrqueioFormDefinitionBinding();
  }

  public Expression getOrqueioFormDefinitionVersion() {
    return formDefinition.getOrqueioFormDefinitionVersion();
  }
