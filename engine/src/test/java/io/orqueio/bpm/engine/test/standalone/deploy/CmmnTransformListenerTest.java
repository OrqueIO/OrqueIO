...
import static io.orqueio.bpm.engine.test.standalone.deploy.TestCmmnTransformListener.numberOfRegistered;
...
public class CmmnTransformListenerTest {
  ...
  public static ProcessEngineBootstrapRule bootstrapRule = new ProcessEngineBootstrapRule(
      "io/orqueio/bpm/engine/test/standalone/deploy/cmmn.transform.listener.orqueio.cfg.xml");
  @Rule
