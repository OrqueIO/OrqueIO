...
public class OrqueioBpmRunAuthenticationProperties {

  public static final String PREFIX = OrqueioBpmRunProperties.PREFIX + ".auth";
  ...
  public String toString() {
    return "OrqueioBpmRunAuthenticationProperties [enabled=" + enabled + ", authentication=" + authentication + "]";
  }
}
