...
public interface ProcessEngineService {
  ...
  /**
   * @return all {@link ProcessEngine ProcessEngines} managed by the Orqueio Platform.
   */
  public List<ProcessEngine> getProcessEngines();

  /**
   *
   * @return the names of all {@link ProcessEngine ProcessEngines} managed by the Orqueio Platform.
   */
