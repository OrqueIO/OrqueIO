...
import static io.orqueio.bpm.model.bpmn.impl.BpmnModelConstants.ORQUEIO_ELEMENT_TASK_LISTENER;
import static io.orqueio.bpm.model.bpmn.impl.BpmnModelConstants.ORQUEIO_NS;
import static io.orqueio.bpm.model.xml.type.ModelElementTypeBuilder.ModelTypeInstanceProvider;

/**
 * The BPMN taskListener orqueio extension element
 *
 * @author Sebastian Menski
 */
public class OrqueioTaskListenerImpl extends BpmnModelElementInstanceImpl implements OrqueioTaskListener {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(OrqueioTaskListener.class, ORQUEIO_ELEMENT_TASK_LISTENER)
      .namespaceUri(ORQUEIO_NS)
      .instanceProvider(new ModelTypeInstanceProvider<OrqueioTaskListener>() {
        public OrqueioTaskListener newInstance(ModelTypeInstanceContext instanceContext) {
          return new OrqueioTaskListenerImpl(instanceContext);
        }
      });
  ...
  public OrqueioTaskListenerImpl(ModelTypeInstanceContext instanceContext) {
