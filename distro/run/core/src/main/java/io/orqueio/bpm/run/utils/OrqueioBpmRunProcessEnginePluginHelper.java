...
public class OrqueioBpmRunProcessEnginePluginHelper {

  protected static final OrqueioBpmRunLogger LOG = OrqueioBpmRunLogger.LOG;

  public static void registerYamlPlugins(List<ProcessEnginePlugin> processEnginePlugins,
                                         List<OrqueioBpmRunProcessEnginePluginProperty> pluginsInfo) {

    for (OrqueioBpmRunProcessEnginePluginProperty pluginInfo : pluginsInfo) {
