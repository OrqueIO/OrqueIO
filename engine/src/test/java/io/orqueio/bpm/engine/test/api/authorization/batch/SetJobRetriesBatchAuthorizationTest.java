...
import io.orqueio.bpm.engine.test.api.authorization.util.AuthorizationScenarioWithCount;
...
public class SetJobRetriesBatchAuthorizationTest extends AbstractBatchAuthorizationTest {
  ...
  protected static final String DEFINITION_XML = "io/orqueio/bpm/engine/test/api/mgmt/ManagementServiceTest.testGetJobExceptionStacktrace.bpmn20.xml";
