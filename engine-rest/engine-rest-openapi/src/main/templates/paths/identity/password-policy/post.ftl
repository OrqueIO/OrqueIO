...
<#-- Generated From File: orqueio-docs-manual/public/reference/rest/identity/validate-password/index.html -->
{
  <@lib.endpointInfo
      id = "checkPassword"
      tag = "Identity"
      ...
      desc = "A password policy consists of a list of rules that new passwords must follow to be
              ...
              end point. More information on password policies in Orqueio can be found in the password policy
