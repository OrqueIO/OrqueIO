...
import static io.orqueio.bpm.engine.test.bpmn.executionlistener.ThrowingHistoryEventProducer.ERROR_CODE;
import static io.orqueio.bpm.engine.test.bpmn.executionlistener.ThrowingHistoryEventProducer.EXCEPTION_MESSAGE;
...
public class ThrowingHistoryExecutionListenerTest {
  ...
  // NOTE: it is fine to alter the result of these tests, see https://jira.orqueio.com/browse/CAM-14408
  ...
  protected BpmnModelInstance createModelWithCatchInServiceTaskAndListener(String eventName) {
    return Bpmn.createExecutableProcess(PROCESS_KEY)
          ...
          .userTask("userTask1")
          .serviceTask("throw")
            .orqueioExecutionListenerClass(eventName, ThrowBPMNErrorDelegate.class)
