...
import io.orqueio.bpm.engine.impl.bpmn.parser.ResourceReportImpl;
...
import static io.orqueio.bpm.engine.rest.helper.MockProvider.*;
...
public class DeploymentRestServiceInteractionTest extends AbstractRestServiceTest {
  ...
  @Test
  public void testGetDeploymentOrqueioFormResourceData() {
    Resource resource = MockProvider.createMockDeploymentOrqueioFormResource();
