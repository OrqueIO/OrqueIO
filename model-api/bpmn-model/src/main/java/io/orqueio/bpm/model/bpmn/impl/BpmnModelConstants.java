 ...
 */
package io.orqueio.bpm.model.bpmn.impl;
...
public final class BpmnModelConstants {
  ...
  public static final String ORQUEIO_ELEMENT_CONNECTOR = "connector";
  public static final String ORQUEIO_ELEMENT_CONNECTOR_ID = "connectorId";
  public static final String ORQUEIO_ELEMENT_CONSTRAINT = "constraint";
  public static final String ORQUEIO_ELEMENT_ENTRY = "entry";
  public static final String ORQUEIO_ELEMENT_ERROR_EVENT_DEFINITION = "errorEventDefinition";
  public static final String ORQUEIO_ELEMENT_EXECUTION_LISTENER = "executionListener";
  public static final String ORQUEIO_ELEMENT_EXPRESSION = "expression";
  public static final String ORQUEIO_ELEMENT_FAILED_JOB_RETRY_TIME_CYCLE = "failedJobRetryTimeCycle";
  public static final String ORQUEIO_ELEMENT_FIELD = "field";
  public static final String ORQUEIO_ELEMENT_FORM_DATA = "formData";
  public static final String ORQUEIO_ELEMENT_FORM_FIELD = "formField";
  public static final String ORQUEIO_ELEMENT_FORM_PROPERTY = "formProperty";
  public static final String ORQUEIO_ELEMENT_IN = "in";
  public static final String ORQUEIO_ELEMENT_INPUT_OUTPUT = "inputOutput";
  public static final String ORQUEIO_ELEMENT_INPUT_PARAMETER = "inputParameter";
  public static final String ORQUEIO_ELEMENT_LIST = "list";
  public static final String ORQUEIO_ELEMENT_MAP = "map";
  public static final String ORQUEIO_ELEMENT_OUTPUT_PARAMETER = "outputParameter";
  public static final String ORQUEIO_ELEMENT_OUT = "out";
  public static final String ORQUEIO_ELEMENT_POTENTIAL_STARTER = "potentialStarter";
  public static final String ORQUEIO_ELEMENT_PROPERTIES = "properties";
  public static final String ORQUEIO_ELEMENT_PROPERTY = "property";
  ...
  public static final String ORQUEIO_ELEMENT_VALIDATION = "validation";
  public static final String ORQUEIO_ELEMENT_VALUE = "value";
  ...
  public static final String ORQUEIO_ATTRIBUTE_ASYNC = "async";
  public static final String ORQUEIO_ATTRIBUTE_ASYNC_BEFORE = "asyncBefore";
  public static final String ORQUEIO_ATTRIBUTE_ASYNC_AFTER = "asyncAfter";
  public static final String ORQUEIO_ATTRIBUTE_BUSINESS_KEY = "businessKey";
  public static final String ORQUEIO_ATTRIBUTE_CALLED_ELEMENT_BINDING = "calledElementBinding";
  public static final String ORQUEIO_ATTRIBUTE_CALLED_ELEMENT_VERSION = "calledElementVersion";
  public static final String ORQUEIO_ATTRIBUTE_CALLED_ELEMENT_VERSION_TAG = "calledElementVersionTag";
  public static final String ORQUEIO_ATTRIBUTE_CALLED_ELEMENT_TENANT_ID = "calledElementTenantId";
  public static final String ORQUEIO_ATTRIBUTE_CANDIDATE_GROUPS = "candidateGroups";
  public static final String ORQUEIO_ATTRIBUTE_CANDIDATE_STARTER_GROUPS = "candidateStarterGroups";
  public static final String ORQUEIO_ATTRIBUTE_CANDIDATE_STARTER_USERS = "candidateStarterUsers";
  ...
  public static final String ORQUEIO_ATTRIBUTE_COLLECTION = "collection";
  public static final String ORQUEIO_ATTRIBUTE_CONFIG = "config";
  public static final String ORQUEIO_ATTRIBUTE_DATE_PATTERN = "datePattern";
  public static final String ORQUEIO_ATTRIBUTE_DECISION_REF = "decisionRef";
  public static final String ORQUEIO_ATTRIBUTE_DECISION_REF_BINDING = "decisionRefBinding";
  public static final String ORQUEIO_ATTRIBUTE_DECISION_REF_VERSION = "decisionRefVersion";
  public static final String ORQUEIO_ATTRIBUTE_DECISION_REF_VERSION_TAG = "decisionRefVersionTag";
  public static final String ORQUEIO_ATTRIBUTE_DECISION_REF_TENANT_ID = "decisionRefTenantId";
  public static final String ORQUEIO_ATTRIBUTE_DEFAULT = "default";
  public static final String ORQUEIO_ATTRIBUTE_DEFAULT_VALUE = "defaultValue";
  ...
  public static final String ORQUEIO_ATTRIBUTE_ELEMENT_VARIABLE = "elementVariable";
  public static final String ORQUEIO_ATTRIBUTE_EVENT = "event";
  public static final String ORQUEIO_ATTRIBUTE_ERROR_CODE_VARIABLE = "errorCodeVariable";
  public static final String ORQUEIO_ATTRIBUTE_ERROR_MESSAGE_VARIABLE = "errorMessageVariable";
  public static final String ORQUEIO_ATTRIBUTE_ERROR_MESSAGE = "errorMessage";
  public static final String ORQUEIO_ATTRIBUTE_EXCLUSIVE = "exclusive";
  public static final String ORQUEIO_ATTRIBUTE_EXPRESSION = "expression";
  public static final String ORQUEIO_ATTRIBUTE_FORM_HANDLER_CLASS = "formHandlerClass";
  public static final String ORQUEIO_ATTRIBUTE_FORM_KEY = "formKey";
  public static final String ORQUEIO_ATTRIBUTE_FORM_REF = "formRef";
  public static final String ORQUEIO_ATTRIBUTE_FORM_REF_BINDING = "formRefBinding";
  public static final String ORQUEIO_ATTRIBUTE_FORM_REF_VERSION = "formRefVersion";
  public static final String ORQUEIO_ATTRIBUTE_ID = "id";
  public static final String ORQUEIO_ATTRIBUTE_INITIATOR = "initiator";
  public static final String ORQUEIO_ATTRIBUTE_JOB_PRIORITY = "jobPriority";
  public static final String ORQUEIO_ATTRIBUTE_TASK_PRIORITY = "taskPriority";
  public static final String ORQUEIO_ATTRIBUTE_KEY = "key";
  public static final String ORQUEIO_ATTRIBUTE_LABEL = "label";
  ...
  public static final String ORQUEIO_ATTRIBUTE_READABLE = "readable";
  public static final String ORQUEIO_ATTRIBUTE_REQUIRED = "required";
  ...
  public static final String ORQUEIO_ATTRIBUTE_TOPIC = "topic";
  public static final String ORQUEIO_ATTRIBUTE_TYPE = "type";
  public static final String ORQUEIO_ATTRIBUTE_VALUE = "value";
  public static final String ORQUEIO_ATTRIBUTE_VARIABLE = "variable";
  public static final String ORQUEIO_ATTRIBUTE_VARIABLE_MAPPING_CLASS = "variableMappingClass";
  public static final String ORQUEIO_ATTRIBUTE_VARIABLE_MAPPING_DELEGATE_EXPRESSION = "variableMappingDelegateExpression";
  public static final String ORQUEIO_ATTRIBUTE_VARIABLES = "variables";
  public static final String ORQUEIO_ATTRIBUTE_WRITEABLE = "writeable";
  public static final String ORQUEIO_ATTRIBUTE_CASE_REF = "caseRef";
  ...
  public static final String ORQUEIO_ATTRIBUTE_VARIABLE_EVENTS = "variableEvents";
  public static final String ORQUEIO_ATTRIBUTE_HISTORY_TIME_TO_LIVE = "historyTimeToLive";
  public static final String ORQUEIO_ATTRIBUTE_IS_STARTABLE_IN_TASKLIST = "isStartableInTasklist";
