 ...
 */
package io.orqueio.bpm.integrationtest.functional.jodatime;
...
public class JodaTimeClassloadingTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    return initWebArchiveDeployment().addAsResource("io/orqueio/bpm/integrationtest/functional/jodatime/JodaTimeClassloadingTest.bpmn20.xml");
  }
