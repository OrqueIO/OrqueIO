...
VALUES
  ('orqueio-admin-grant-tenant', 1, 'orqueio-admin', 11, '*', 2147483647, 1),
  ('orqueio-admin-grant-tenant-membership', 1, 'orqueio-admin', 12, '*', 2147483647, 1),
  ('orqueio-admin-grant-batch', 1, 'orqueio-admin', 13, '*', 2147483647, 1);
