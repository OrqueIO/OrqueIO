...
import static io.orqueio.bpm.engine.authorization.Permissions.DELETE_INSTANCE;
...
import static io.orqueio.bpm.engine.authorization.ProcessDefinitionPermissions.SUSPEND_INSTANCE;
import static io.orqueio.bpm.engine.authorization.ProcessDefinitionPermissions.UPDATE_INSTANCE_VARIABLE;
import static io.orqueio.bpm.engine.authorization.ProcessInstancePermissions.SUSPEND;
import static io.orqueio.bpm.engine.authorization.ProcessInstancePermissions.UPDATE_VARIABLE;
...
public class ProcessInstanceAuthorizationTest extends AuthorizationTest {
  ...
  public void setUp() throws Exception {
    testRule.deploy(
        ...
        "io/orqueio/bpm/engine/test/api/authorization/messageStartEventProcess.bpmn20.xml",
        "io/orqueio/bpm/engine/test/api/authorization/messageBoundaryEventProcess.bpmn20.xml",
        "io/orqueio/bpm/engine/test/api/authorization/signalBoundaryEventProcess.bpmn20.xml",
        "io/orqueio/bpm/engine/test/api/authorization/signalStartEventProcess.bpmn20.xml",
        "io/orqueio/bpm/engine/test/api/authorization/throwWarningSignalEventProcess.bpmn20.xml",
        "io/orqueio/bpm/engine/test/api/authorization/throwAlertSignalEventProcess.bpmn20.xml"
        );
