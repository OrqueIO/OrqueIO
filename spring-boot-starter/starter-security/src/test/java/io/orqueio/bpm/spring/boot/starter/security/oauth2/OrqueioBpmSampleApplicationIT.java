...
public class OrqueioBpmSampleApplicationIT extends AbstractSpringSecurityIT {
  ...
  public void testSpringSecurityAutoConfigurationCorrectlySet() {
    ...
    assertThat(getBeanForClass(OrqueioSpringSecurityOAuth2AutoConfiguration.class, webApplicationContext)).isNull();
    assertThat(getBeanForClass(OrqueioBpmSpringSecurityDisableAutoConfiguration.class, webApplicationContext)).isNotNull();
  }
  ...
  public void testWebappApiIsAvailableAndRequiresAuthorization() {
    ...
    ResponseEntity<String> entity = testRestTemplate.getForEntity(baseUrl + "/orqueio/api/engine/engine/default/user", String.class);
