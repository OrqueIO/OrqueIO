...
This is the OrqueIO web application source.
...
There are 3 web applications available for the OrqueIO :
...
See https://github.com/orqueio/orqueio/blob/master/CONTRIBUTING.md#build-from-source
...
git clone git@github.com:orqueio/orqueio.git
cd orqueio/webapps/frontend
npm install
npm start
```
