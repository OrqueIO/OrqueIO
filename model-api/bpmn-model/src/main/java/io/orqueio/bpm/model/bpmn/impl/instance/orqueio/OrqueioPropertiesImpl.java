...
/**
 * The BPMN properties orqueio extension element
 *
 * @author Sebastian Menski
 */
public class OrqueioPropertiesImpl extends BpmnModelElementInstanceImpl implements OrqueioProperties {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ...
    orqueioPropertyCollection = sequenceBuilder.elementCollection(OrqueioProperty.class)
      .build();

    typeBuilder.build();
  }

  public OrqueioPropertiesImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public Collection<OrqueioProperty> getOrqueioProperties() {
    return orqueioPropertyCollection.get(this);
  }
}
