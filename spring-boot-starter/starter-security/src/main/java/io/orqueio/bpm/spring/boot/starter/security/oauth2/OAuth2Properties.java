...
import io.orqueio.bpm.spring.boot.starter.security.oauth2.impl.OAuth2IdentityProvider;
...
public class OAuth2Properties {
  ...
  public static final String PREFIX = OrqueioBpmProperties.PREFIX + ".oauth2";
