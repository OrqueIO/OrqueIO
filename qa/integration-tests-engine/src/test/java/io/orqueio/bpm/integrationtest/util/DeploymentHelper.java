...
public class DeploymentHelper extends AbstractDeploymentHelper {
  ...
  protected static final String ORQUEIO_EJB_CLIENT = "io.orqueio.bpm.javaee:orqueio-ejb-client";
  protected static final String ORQUEIO_ENGINE_CDI = "io.orqueio.bpm:orqueio-engine-cdi";
  protected static final String ORQUEIO_ENGINE_SPRING = "io.orqueio.bpm:orqueio-engine-spring";
