...
import io.orqueio.bpm.client.impl.ExternalTaskClientBuilderImpl;
import io.orqueio.bpm.client.topic.TopicSubscriptionBuilder;

/**
 * <p>Orqueio external task client</p>
 *
...
public interface ExternalTaskClient {
  ...
  /**
   * Creates a fluent builder to configure the Orqueio client
   *
