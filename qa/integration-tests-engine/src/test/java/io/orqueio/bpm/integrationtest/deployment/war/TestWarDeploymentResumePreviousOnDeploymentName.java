...
public class TestWarDeploymentResumePreviousOnDeploymentName extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive1() {
    return initWebArchiveDeployment("pa1.war").addAsResource("io/orqueio/bpm/integrationtest/deployment/war/testDeployProcessArchiveV1.bpmn20.xml");
  }

  @Deployment(order = 2, name = PA2)
  public static WebArchive processArchive2() {
    return initWebArchiveDeployment("pa2.war", "io/orqueio/bpm/integrationtest/deployment/war/resumePreviousVersionsOnDeploymentName_processes.xml")
        .addAsResource("io/orqueio/bpm/integrationtest/deployment/war/testProcess.bpmn20.xml");
