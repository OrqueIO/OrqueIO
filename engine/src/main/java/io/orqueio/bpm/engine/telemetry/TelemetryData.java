 ...
 *
 * If telemetry is enabled this information is sent to Orqueio. If telemetry is
...
public interface TelemetryData {
   ...
   * Orqueio. It is stored once per database so all engines connected to the
   * same database will have the same installation ID. The ID is used to
   * identify a single installation of Orqueio Platform.
   */
  public String getInstallation();

  /**
   * Returns a data object that stores information about the used Orqueio
   * product.
   */
