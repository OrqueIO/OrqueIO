 ...
 */
package io.orqueio.bpm.engine.test.api.authorization.jobdefinition;
...
public class SetJobDefinitionPriorityAuthorizationTest {
  ...
  @Test
  @Deployment(resources = "io/orqueio/bpm/engine/test/api/authorization/oneIncidentProcess.bpmn20.xml")
