...
import io.orqueio.bpm.model.bpmn.instance.TerminateEventDefinition;
...
public class SelfCancellationTest {
  ...
  public static final BpmnModelInstance PROCESS_WITH_CANCELING_RECEIVE_TASK = Bpmn.createExecutableProcess("process")
      ...
      .userTask()
      .sendTask("sendTask")
        .orqueioClass(SendMessageDelegate.class.getName())
        .orqueioExecutionListenerClass(RecorderExecutionListener.EVENTNAME_END, RecorderExecutionListener.class.getName())
      .endEvent("endEvent")
  ...
  public static final BpmnModelInstance PROCESS_WITH_PARALLEL_SEND_TASK_AND_BOUNDARY_EVENT = Bpmn.createExecutableProcess("process")
      ...
      .sendTask("sendTask")
        .orqueioExecutionListenerClass(RecorderExecutionListener.EVENTNAME_END, RecorderExecutionListener.class.getName())
        .orqueioClass(SignalDelegate.class.getName())
      .boundaryEvent("boundary")
        .message(MESSAGE)
        .orqueioExecutionListenerClass(RecorderExecutionListener.EVENTNAME_END, RecorderExecutionListener.class.getName())
      .endEvent("endEventBoundary")
