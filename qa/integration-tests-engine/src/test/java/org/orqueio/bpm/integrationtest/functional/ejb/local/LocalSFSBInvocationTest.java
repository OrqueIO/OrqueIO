...
import io.orqueio.bpm.integrationtest.functional.ejb.local.bean.LocalSFSBClientDelegateBean;
import io.orqueio.bpm.integrationtest.functional.ejb.local.bean.LocalSFSBean;
...
public class LocalSFSBInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("io/orqueio/bpm/integrationtest/functional/ejb/local/LocalSFSBInvocationTest.testInvokeBean.bpmn20.xml")
