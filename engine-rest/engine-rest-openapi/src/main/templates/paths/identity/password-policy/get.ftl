...
<#-- Generated From File: orqueio-docs-manual/public/reference/rest/identity/get-password-policy/index.html -->
{
  <@lib.endpointInfo
      ...
      desc = "A password policy consists of a list of rules that new passwords must follow to be
              ...
              list of policy rules. More information on password policies in Orqueio can be found in the password policy
