...
public class ConditionalSequenceFlowTest {
  ...
  public void shouldHaveResource() {
    assertThat(conditionExpression1.getOrqueioResource()).isNull();
    assertThat(conditionExpression2.getOrqueioResource()).isNull();
    assertThat(conditionExpression3.getOrqueioResource()).isEqualTo("test.groovy");
  }
