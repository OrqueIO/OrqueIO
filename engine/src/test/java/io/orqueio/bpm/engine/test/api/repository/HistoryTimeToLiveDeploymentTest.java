...
public class HistoryTimeToLiveDeploymentTest {
  ...
  public void processWithHTTLShouldSucceed() {
    ...
    testRule.deploy(repositoryService
        .createDeployment()
        .addClasspathResource("io/orqueio/bpm/engine/test/api/repository/version3.bpmn20.xml"));
  ...
  public void caseWithHTTLShouldSucceed() {
    ...
    testRule.deploy(repositoryService
        .createDeployment()
        .addClasspathResource("io/orqueio/bpm/engine/test/api/cmmn/oneTaskCaseWithHistoryTimeToLive.cmmn"));
  ...
  public void decisionWithHTTLShouldSucceed() {
    ...
    testRule.deploy(repositoryService
        .createDeployment()
        .addClasspathResource("io/orqueio/bpm/engine/test/api/dmn/Example.dmn"));
  ...
  public void decisionWithoutHTTLShouldFail() {
    assertThatThrownBy(() -> {
      ...
      testRule.deploy(repositoryService
          .createDeployment()
          .addClasspathResource("io/orqueio/bpm/engine/test/api/dmn/Another_Example.dmn"));})
  ...
  public void shouldLogMessageOnLongerTTLInfCaseModel() {
    ...
    // when
    testRule.deploy(repositoryService.createDeployment()
        .addClasspathResource("io/orqueio/bpm/engine/test/api/repository/case_with_365_httl.cmmn"));
  ...
  public void shouldLogMessageOnLongerTTLInDecisionModel() {
    ...
    // when
    testRule.deploy(repositoryService.createDeployment()
        .addClasspathResource("io/orqueio/bpm/engine/test/api/repository/decision_with_365_httl.dmn"));
