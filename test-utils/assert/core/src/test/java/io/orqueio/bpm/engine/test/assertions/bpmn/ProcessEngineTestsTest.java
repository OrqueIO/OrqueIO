...
import static io.orqueio.bpm.engine.test.assertions.bpmn.AbstractAssertions.processEngine;
...
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.authorizationService;
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.executionQuery;
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.formService;
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.historyService;
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.identityService;
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.jobQuery;
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.managementService;
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.processDefinitionQuery;
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.processInstanceQuery;
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.repositoryService;
...
import io.orqueio.bpm.engine.test.assertions.cmmn.CaseDefinitionAssert;
import io.orqueio.bpm.engine.test.assertions.cmmn.CaseExecutionAssert;
import io.orqueio.bpm.engine.test.assertions.cmmn.CaseInstanceAssert;
