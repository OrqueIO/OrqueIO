...
public class UniversalOIDCIdentityProviderFactory implements SessionFactory {
     ...
     */
    public UniversalOIDCIdentityProviderFactory(UniversalAuthenticationProperties authProperties) {
    ...
    public Session openSession() {
        return new UniversalOIDCIdentityProvider(authProperties);
    }
}
