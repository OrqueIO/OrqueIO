...
import io.orqueio.bpm.engine.impl.batch.history.DeleteHistoricBatchCmd;
import io.orqueio.bpm.engine.impl.batch.history.HistoricBatchQueryImpl;
import io.orqueio.bpm.engine.impl.cmd.DeleteHistoricCaseInstanceCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteHistoricCaseInstancesBulkCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteHistoricProcessInstancesCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteHistoricTaskInstanceCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteHistoricVariableInstanceCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteHistoricVariableInstancesByProcessInstanceIdCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteUserOperationLogEntryCmd;
import io.orqueio.bpm.engine.impl.cmd.FindHistoryCleanupJobsCmd;
import io.orqueio.bpm.engine.impl.cmd.GetHistoricExternalTaskLogErrorDetailsCmd;
import io.orqueio.bpm.engine.impl.cmd.GetHistoricJobLogExceptionStacktraceCmd;
import io.orqueio.bpm.engine.impl.cmd.HistoryCleanupCmd;
import io.orqueio.bpm.engine.impl.cmd.batch.DeleteHistoricProcessInstancesBatchCmd;
import io.orqueio.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstanceByDefinitionIdCmd;
import io.orqueio.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstanceByInstanceIdCmd;
import io.orqueio.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstancesBatchCmd;
...
import io.orqueio.bpm.engine.impl.history.SetRemovalTimeToHistoricDecisionInstancesBuilderImpl;
import io.orqueio.bpm.engine.impl.history.SetRemovalTimeToHistoricProcessInstancesBuilderImpl;
import io.orqueio.bpm.engine.runtime.Job;

/**
 * @author Tom Baeyens
 * @author Bernd Ruecker (orqueio)
