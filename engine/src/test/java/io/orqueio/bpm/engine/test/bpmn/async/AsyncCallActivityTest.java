...
public class AsyncCallActivityTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = { "io/orqueio/bpm/engine/test/bpmn/async/AsyncCallActivityTest.asyncStartEvent.bpmn20.xml",
  "io/orqueio/bpm/engine/test/bpmn/async/AsyncCallActivityTest.testCallSubProcess.bpmn20.xml" })
  @Test
