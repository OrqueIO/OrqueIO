...
public class OrqueioBpmRunLdapProperties extends LdapIdentityProviderPlugin {

  public static final String PREFIX = OrqueioBpmRunProperties.PREFIX + ".ldap";
  ...
  public String toString() {
    return "OrqueioBpmRunLdapProperty [enabled=" + enabled +
