...
import static io.orqueio.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_ACTIVITY_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_DEFINITION_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_INSTANCE_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOBS_PER_SEED;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOB_DEFINITION_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TOTAL_JOBS;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TYPE;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_INVOCATIONS_PER_BATCH_JOB;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_MONITOR_JOB_DEFINITION_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_SEED_JOB_DEFINITION_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.NON_EXISTING_ACTIVITY_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.NON_EXISTING_PROCESS_DEFINITION_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.createMockBatch;
import static io.orqueio.bpm.engine.rest.helper.NoIntermediaryInvocation.immediatelyAfter;
import static org.assertj.core.api.Assertions.assertThat;
import static io.orqueio.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.*;
...
import io.orqueio.bpm.engine.migration.MigratingProcessInstanceValidationReport;
import io.orqueio.bpm.engine.migration.MigratingTransitionInstanceValidationReport;
...
import io.orqueio.bpm.engine.rest.helper.FluentAnswer;
import io.orqueio.bpm.engine.rest.helper.MockMigrationPlanBuilder;
import io.orqueio.bpm.engine.rest.helper.MockMigrationPlanBuilder.JoinedMigrationPlanBuilderMock;
import io.orqueio.bpm.engine.rest.util.container.TestContainerRule;
import io.orqueio.bpm.engine.rest.util.migration.MigrationExecutionDtoBuilder;
import io.orqueio.bpm.engine.rest.util.migration.MigrationPlanDtoBuilder;
...
import io.orqueio.bpm.engine.rest.util.migration.MigrationInstructionDtoBuilder;
