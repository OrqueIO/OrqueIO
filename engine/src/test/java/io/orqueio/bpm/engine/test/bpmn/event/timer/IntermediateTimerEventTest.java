...
public class IntermediateTimerEventTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "io/orqueio/bpm/engine/test/bpmn/event/timer/IntermediateTimerEventTest.testExpressionRecalculateCurrentDateBased.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "io/orqueio/bpm/engine/test/bpmn/event/timer/IntermediateTimerEventTest.testRecalculateTimeCycleExpressionCurrentDateBased.bpmn20.xml")
  @Test
