 ...
 */
package io.orqueio.bpm.pa.rest;
...
import io.orqueio.bpm.admin.impl.web.SetupResource;
 ...
 *
 * Invoke using GET /orqueio/ensureCleanDb/{engineName}
 *
...
public class TestServlet extends HttpServlet {
  ...
  protected void deleteAdminUser(ProcessEngine processEngine) {
    ...
    identityService.deleteMembership("admin", Groups.ORQUEIO_ADMIN);

    identityService.deleteGroup(Groups.ORQUEIO_ADMIN);
