 ...
 */
package io.orqueio.bpm.engine.spring.test.expression.callactivity;

import io.orqueio.bpm.engine.runtime.ProcessInstance;
import io.orqueio.bpm.engine.spring.test.SpringProcessEngineTestCase;
 ...
 */
@ContextConfiguration("classpath:io/orqueio/bpm/engine/spring/test/expression/callactivity/testCallActivityByExpression-context.xml")
public class CallActivityBasedOnSpringBeansExpressionTest extends SpringProcessEngineTestCase {

	@Deployment(resources = {
			"io/orqueio/bpm/engine/spring/test/expression/callactivity/CallActivityBasedOnSpringBeansExpressionTest.testCallActivityByExpression.bpmn20.xml",
			"io/orqueio/bpm/engine/spring/test/expression/callactivity/simpleSubProcess.bpmn20.xml" })
