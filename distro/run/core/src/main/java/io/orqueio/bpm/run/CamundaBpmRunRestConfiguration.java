...
public class CamundaBpmRunRestConfiguration {
  ...
  @Autowired
  CamundaBpmRunProperties orqueioBpmRunProperties;
  ...
  public FilterRegistrationBean<Filter> processEngineAuthenticationFilter(JerseyApplicationPath applicationPath) {
    ...
    CamundaBpmRunAuthenticationProperties properties = orqueioBpmRunProperties.getAuth();
  ...
  @Bean
  public CamundaJerseyResourceConfig orqueioRunJerseyResourceConfig() {
    CamundaJerseyResourceConfig orqueioJerseyResourceConfig = new CamundaJerseyResourceConfig();
