...
public @interface StartProcess {
	...
	/**
	 * returns the ID of the {@link io.orqueio.bpm.engine.runtime.ProcessInstance}. If specified, it'll only work if
	 * the return type of the invocation is compatabile with a {@link io.orqueio.bpm.engine.runtime.ProcessInstance}'s ID
