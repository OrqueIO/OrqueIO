...
import static io.orqueio.bpm.identity.ldap.util.LdapTestUtilities.testGroupPaging;
...
import io.orqueio.bpm.identity.ldap.util.LdapTestUtilities;
...
public class LdapDisableAuthorizationCheckTest {
  ...
  @Rule
  public ProcessEngineRule engineRule = new ProcessEngineRule("orqueio.ldap.disable.authorization.check.cfg.xml");
