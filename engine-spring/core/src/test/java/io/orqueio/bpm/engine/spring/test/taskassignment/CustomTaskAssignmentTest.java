 ...
 */
package io.orqueio.bpm.engine.spring.test.taskassignment;
 ...
 * @author Joram Barrez
 */
@ContextConfiguration("classpath:io/orqueio/bpm/engine/spring/test/taskassignment/taskassignment-context.xml")
