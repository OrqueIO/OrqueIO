 ...
 */
package io.orqueio.bpm.engine.spring.test.taskListener;
 ...
 * @author Joram Barrez
 */
@ContextConfiguration("classpath:io/orqueio/bpm/engine/spring/test/taskListener/TaskListenerDelegateExpressionTest-context.xml")
