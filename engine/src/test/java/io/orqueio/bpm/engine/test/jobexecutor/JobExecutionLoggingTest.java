...
import io.orqueio.bpm.engine.impl.jobexecutor.CallerRunsRejectedJobsHandler;
...
public class JobExecutionLoggingTest {
  ...
  public ProcessEngineLoggingRule loggingRule = new ProcessEngineLoggingRule().watch(
      "io.orqueio.bpm.engine.jobexecutor", Level.DEBUG);
  ...
  @Test
  @Deployment(resources = { "io/orqueio/bpm/engine/test/jobexecutor/SimpleAsyncDelayProcess.bpmn20.xml" })
