...
import static io.orqueio.bpm.engine.authorization.Resources.GROUP_MEMBERSHIP;
import static io.orqueio.bpm.engine.authorization.Resources.TENANT;
import static io.orqueio.bpm.engine.authorization.Resources.TENANT_MEMBERSHIP;
import static io.orqueio.bpm.engine.authorization.Resources.USER;
import static io.orqueio.bpm.engine.test.api.authorization.util.AuthorizationTestUtil.assertExceptionInfo;
...
public class IdentityServiceAuthorizationsTest extends PluggableProcessEngineTest {
  ...
  public void testUserUnlock() throws ParseException {
    ...
    // set auth
    processEngineConfiguration.setAuthorizationEnabled(true);
    identityService.setAuthentication("admin", Collections.singletonList(Groups.ORQUEIO_ADMIN), null);
