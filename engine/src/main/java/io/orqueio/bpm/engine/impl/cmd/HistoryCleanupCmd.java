...
import io.orqueio.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupContext;
import io.orqueio.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHelper;
import io.orqueio.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupJobDeclaration;
...
public class HistoryCleanupCmd implements Command<Job> {
  ...
  public Job execute(CommandContext context) {
    ...
    authorizationManager.checkOrqueioAdmin();
