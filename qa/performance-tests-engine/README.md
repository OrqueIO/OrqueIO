...
mvn clean install -Pbenchmark,h2 \ 
                  -DlongTermBenchmarkResultFile=C:\\Arbeit\\orqueio\\performanceTests\\longtermResults.csv
```
...
```json
{
    "testName": "io.orqueio.bpm.qa.performance.engine.bpmn.SequencePerformanceTest.asyncSequence1Step",
    "configuration": {
        "numberOfThreads": 1,
        "numberOfRuns": 1,
        "testWatchers": "io.orqueio.bpm.qa.performance.engine.sql.statementlog.StatementLogPerfTestWatcher"
    },
    "duration": 20,
    "stepResults": [
        {
...
mvn clean install -Pbenchmark,mysql \
                  ...
                  -Ddatabase.url=jdbc:mysql://localhost:3306:orqueio \
