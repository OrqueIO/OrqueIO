...
@ContextConfiguration(locations = {
    "classpath:io/orqueio/bpm/engine/spring/test/dmn/DmnJuelTest-applicationContext.xml" })
public class DmnJuelTest {
  ...
  public void deploy() {
    deploymentId = repositoryService.createDeployment()
        .addClasspathResource("io/orqueio/bpm/engine/spring/test/dmn/JuelTest.dmn")
        .deploy()
        .getId();
  }
