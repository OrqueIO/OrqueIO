...
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskByTimestamp;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByActivityId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByActivityInstanceId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByExecutionId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByExternalTaskId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByPriority;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByProcessDefinitionId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByProcessDefinitionKey;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByProcessInstanceId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByRetries;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByTopicName;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByWorkerId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.inverted;
import static io.orqueio.bpm.engine.test.api.runtime.migration.models.builder.DefaultExternalTaskModelBuilder.DEFAULT_TOPIC;
import static io.orqueio.bpm.engine.test.api.runtime.migration.models.builder.DefaultExternalTaskModelBuilder.createDefaultExternalTaskModel;
...
import io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil;
import io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.NullTolerantComparator;
