...
var $ = (window.jQuery = window.$ = require('jquery')),
  ...
  camCommonsUi = require('orqueio-commons-ui/lib'),
  sdk = require('orqueio-bpm-sdk-js/lib/angularjs/index'),
  angular = require('orqueio-commons-ui/vendor/angular'),
  camCommon = require('../../../common/scripts/module'),
  lodash = require('orqueio-commons-ui/vendor/lodash'),
  moment = require('orqueio-commons-ui/vendor/moment');
...
export function exposePackages(requirePackages) {
  ...
  requirePackages['orqueio-commons-ui'] = camCommonsUi;
  requirePackages['orqueio-bpm-sdk-js'] = sdk;
