...
import static io.orqueio.bpm.engine.impl.ExternalTaskQueryProperty.PRIORITY;
...
import io.orqueio.bpm.engine.impl.externaltask.LockedExternalTaskImpl;
import io.orqueio.bpm.engine.impl.externaltask.TopicFetchInstruction;
...
public class FetchExternalTasksCmd implements Command<List<LockedExternalTask>> {
  ...
  public List<LockedExternalTask> execute(CommandContext commandContext) {
    ...
    for (ExternalTaskEntity entity : externalTasks) {
      ...
      // retrieve the execution first to detect concurrent modifications @https://jira.orqueio.com/browse/CAM-10750
