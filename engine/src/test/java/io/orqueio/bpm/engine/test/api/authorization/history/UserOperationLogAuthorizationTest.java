...
import static io.orqueio.bpm.engine.authorization.ProcessDefinitionPermissions.UPDATE_HISTORY;
...
import static io.orqueio.bpm.engine.authorization.UserOperationLogCategoryPermissions.DELETE;
...
import static io.orqueio.bpm.engine.history.UserOperationLogEntry.CATEGORY_TASK_WORKER;
...
public class UserOperationLogAuthorizationTest extends AuthorizationTest {
  ...
  public void setUp() throws Exception {
    deploymentId = testRule.deploy(
        ...
        "io/orqueio/bpm/engine/test/api/authorization/timerBoundaryEventProcess.bpmn20.xml")
            .getId();
    super.setUp();
  }
