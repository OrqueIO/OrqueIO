...
public class ProcessInstanceQueryByLeafInstancesTest {
  ...
  @Deployment(resources = { "io/orqueio/bpm/engine/test/api/runtime/superProcessWithNestedSubProcess.bpmn20.xml",
      "io/orqueio/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml", "io/orqueio/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
  ...
  @Test
  @Deployment(resources = { "io/orqueio/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml",
  ...
  @Test
  @Deployment(resources = { "io/orqueio/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
