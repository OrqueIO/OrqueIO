...
public class OrqueioListTest extends BpmnModelElementInstanceTest {
  ...
  public void testListValueChildAssignment() {
    try {
      ...
      OrqueioValue valueElement = modelInstance.newInstance(OrqueioValue.class);
      valueElement.setTextContent("test");

      listElement.addChildElement(valueElement);

    } catch (Exception e) {
      fail("OrqueioValue should be accepted as a child element of OrqueioList. Error: " + e.getMessage());
    }
  }
}
