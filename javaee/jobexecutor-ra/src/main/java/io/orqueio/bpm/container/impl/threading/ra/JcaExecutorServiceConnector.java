...
public class JcaExecutorServiceConnector implements ResourceAdapter, Serializable {
  ...
  public void start(BootstrapContext ctx) throws ResourceAdapterInternalException {
    ...
    try {
      ...
      log.info("ProcessEngine classes not found in shared libraries. Not initializing OrqueIO JobExecutor Resource Adapter.");
      return;
    }
    ...
    log.log(Level.INFO, "OrqueIO executor service started.");
  }
  ...
  public void stop() {
    ...
    log.log(Level.INFO, "OrqueIO executor service stopped.");
  ...
  public void endpointActivation(MessageEndpointFactory endpointFactory, ActivationSpec spec) throws ResourceException {
    if(jobHandlerActivation != null) {
      throw new ResourceException("The OrqueIO job executor can only service a single MessageEndpoint for job execution. " +
