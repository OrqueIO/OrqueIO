...
import io.orqueio.bpm.engine.impl.cmd.CreateIncidentCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteProcessInstanceCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteProcessInstancesCmd;
import io.orqueio.bpm.engine.impl.cmd.FindActiveActivityIdsCmd;
import io.orqueio.bpm.engine.impl.cmd.GetActivityInstanceCmd;
import io.orqueio.bpm.engine.impl.cmd.GetExecutionVariableCmd;
import io.orqueio.bpm.engine.impl.cmd.GetExecutionVariableTypedCmd;
import io.orqueio.bpm.engine.impl.cmd.GetExecutionVariablesCmd;
import io.orqueio.bpm.engine.impl.cmd.GetStartFormCmd;
import io.orqueio.bpm.engine.impl.cmd.MessageEventReceivedCmd;
import io.orqueio.bpm.engine.impl.cmd.PatchExecutionVariablesCmd;
import io.orqueio.bpm.engine.impl.cmd.RemoveExecutionVariablesCmd;
import io.orqueio.bpm.engine.impl.cmd.ResolveIncidentCmd;
import io.orqueio.bpm.engine.impl.cmd.SetAnnotationForIncidentCmd;
import io.orqueio.bpm.engine.impl.cmd.SetExecutionVariablesCmd;
import io.orqueio.bpm.engine.impl.cmd.SignalCmd;
import io.orqueio.bpm.engine.impl.cmd.batch.DeleteProcessInstanceBatchCmd;
import io.orqueio.bpm.engine.impl.cmd.batch.variables.SetVariablesToProcessInstancesBatchCmd;
...
import io.orqueio.bpm.engine.runtime.ConditionEvaluationBuilder;
...
import io.orqueio.bpm.engine.runtime.NativeExecutionQuery;
import io.orqueio.bpm.engine.runtime.NativeProcessInstanceQuery;
