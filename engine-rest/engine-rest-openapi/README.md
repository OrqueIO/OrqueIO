...
([io.orqueio.bpm.engine.rest.dto.ExceptionDto.java](https://github.com/orqueio/orqueio/blob/master/engine-rest/engine-rest/src/main/java/io/orqueio/bpm/engine/rest/dto/ExceptionDto.java) --> 
