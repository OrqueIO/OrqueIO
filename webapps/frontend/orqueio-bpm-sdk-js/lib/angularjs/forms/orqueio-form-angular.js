...
var OrqueioForm = require('./../../forms/orqueio-form');

var angular = require('angular');
var $ = OrqueioForm.$;
var constants = require('./../../forms/constants');

var OrqueioFormAngular = OrqueioForm.extend({
  renderForm: function() {
    var self = this;
    ...
    OrqueioForm.prototype.renderForm.apply(this, arguments);
  ...
  fireEvent: function() {
    ...
    var doFireEvent = function() {
      OrqueioForm.prototype.fireEvent.apply(self, args);
    };
...
module.exports = OrqueioFormAngular;
