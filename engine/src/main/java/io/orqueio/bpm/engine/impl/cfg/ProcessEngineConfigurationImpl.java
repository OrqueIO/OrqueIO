...
import static io.orqueio.bpm.engine.impl.cmd.HistoryCleanupCmd.MAX_THREADS_NUMBER;
...
import io.orqueio.bpm.engine.impl.DecisionServiceImpl;
import io.orqueio.bpm.engine.impl.DefaultArtifactFactory;
import io.orqueio.bpm.engine.impl.ExternalTaskServiceImpl;
import io.orqueio.bpm.engine.impl.FilterServiceImpl;
import io.orqueio.bpm.engine.impl.FormServiceImpl;
import io.orqueio.bpm.engine.impl.HistoryServiceImpl;
import io.orqueio.bpm.engine.impl.IdentityServiceImpl;
import io.orqueio.bpm.engine.impl.ManagementServiceImpl;
import io.orqueio.bpm.engine.impl.ModificationBatchJobHandler;
import io.orqueio.bpm.engine.impl.OptimizeService;
import io.orqueio.bpm.engine.impl.PriorityProvider;
import io.orqueio.bpm.engine.impl.ProcessEngineImpl;
import io.orqueio.bpm.engine.impl.ProcessEngineLogger;
import io.orqueio.bpm.engine.impl.RepositoryServiceImpl;
import io.orqueio.bpm.engine.impl.RestartProcessInstancesJobHandler;
import io.orqueio.bpm.engine.impl.RuntimeServiceImpl;
import io.orqueio.bpm.engine.impl.ServiceImpl;
import io.orqueio.bpm.engine.impl.TaskServiceImpl;
...
import io.orqueio.bpm.engine.impl.batch.BatchMonitorJobHandler;
import io.orqueio.bpm.engine.impl.batch.BatchSeedJobHandler;
import io.orqueio.bpm.engine.impl.batch.deletion.DeleteHistoricProcessInstancesJobHandler;
import io.orqueio.bpm.engine.impl.batch.deletion.DeleteProcessInstancesJobHandler;
import io.orqueio.bpm.engine.impl.batch.externaltask.SetExternalTaskRetriesJobHandler;
import io.orqueio.bpm.engine.impl.batch.job.SetJobRetriesJobHandler;
import io.orqueio.bpm.engine.impl.batch.message.MessageCorrelationBatchJobHandler;
import io.orqueio.bpm.engine.impl.batch.removaltime.BatchSetRemovalTimeJobHandler;
import io.orqueio.bpm.engine.impl.batch.removaltime.DecisionSetRemovalTimeJobHandler;
import io.orqueio.bpm.engine.impl.batch.removaltime.ProcessSetRemovalTimeJobHandler;
import io.orqueio.bpm.engine.impl.batch.update.UpdateProcessInstancesSuspendStateJobHandler;
import io.orqueio.bpm.engine.impl.batch.variables.BatchSetVariablesHandler;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
...
import io.orqueio.bpm.engine.impl.calendar.BusinessCalendarManager;
...
import io.orqueio.bpm.engine.impl.calendar.MapBusinessCalendarManager;
import io.orqueio.bpm.engine.impl.cfg.auth.AuthorizationCommandChecker;
...
import io.orqueio.bpm.engine.impl.cfg.multitenancy.TenantCommandChecker;
...
import io.orqueio.bpm.engine.impl.cmmn.CaseServiceImpl;
...
import io.orqueio.bpm.engine.impl.cmmn.entity.runtime.CaseSentryPartManager;
import io.orqueio.bpm.engine.impl.cmmn.handler.DefaultCmmnElementHandlerRegistry;
import io.orqueio.bpm.engine.impl.cmmn.transformer.CmmnTransformFactory;
import io.orqueio.bpm.engine.impl.cmmn.transformer.CmmnTransformListener;
import io.orqueio.bpm.engine.impl.cmmn.transformer.CmmnTransformer;
import io.orqueio.bpm.engine.impl.cmmn.transformer.DefaultCmmnTransformFactory;
import io.orqueio.bpm.engine.impl.db.DbIdGenerator;
import io.orqueio.bpm.engine.impl.db.entitymanager.DbEntityManagerFactory;
import io.orqueio.bpm.engine.impl.db.entitymanager.cache.DbEntityCacheKeyMapping;
import io.orqueio.bpm.engine.impl.db.sql.DbSqlPersistenceProviderFactory;
import io.orqueio.bpm.engine.impl.db.sql.DbSqlSessionFactory;
import io.orqueio.bpm.engine.impl.delegate.DefaultDelegateInterceptor;
import io.orqueio.bpm.engine.impl.diagnostics.DiagnosticsCollector;
import io.orqueio.bpm.engine.impl.diagnostics.DiagnosticsRegistry;
import io.orqueio.bpm.engine.impl.digest.Default16ByteSaltGenerator;
import io.orqueio.bpm.engine.impl.digest.PasswordEncryptor;
import io.orqueio.bpm.engine.impl.digest.PasswordManager;
import io.orqueio.bpm.engine.impl.digest.SaltGenerator;
import io.orqueio.bpm.engine.impl.digest.Sha512HashDigest;
import io.orqueio.bpm.engine.impl.dmn.batch.DeleteHistoricDecisionInstancesJobHandler;
import io.orqueio.bpm.engine.impl.dmn.configuration.DmnEngineConfigurationBuilder;
import io.orqueio.bpm.engine.impl.dmn.deployer.DecisionDefinitionDeployer;
import io.orqueio.bpm.engine.impl.dmn.deployer.DecisionRequirementsDefinitionDeployer;
...
import io.orqueio.bpm.engine.impl.el.CommandContextFunctions;
import io.orqueio.bpm.engine.impl.el.DateTimeFunctions;
import io.orqueio.bpm.engine.impl.el.ElProviderCompatible;
...
import io.orqueio.bpm.engine.impl.event.CompensationEventHandler;
import io.orqueio.bpm.engine.impl.event.ConditionalEventHandler;
import io.orqueio.bpm.engine.impl.event.EventHandler;
import io.orqueio.bpm.engine.impl.event.EventHandlerImpl;
...
import io.orqueio.bpm.engine.impl.form.type.FormTypes;
import io.orqueio.bpm.engine.impl.form.type.LongFormType;
...
import io.orqueio.bpm.engine.impl.history.HistoryRemovalTimeProvider;
import io.orqueio.bpm.engine.impl.history.event.HistoricDecisionInstanceManager;
import io.orqueio.bpm.engine.impl.history.event.HostnameProvider;
...
import io.orqueio.bpm.engine.impl.history.parser.HistoryParseListener;
import io.orqueio.bpm.engine.impl.history.producer.CacheAwareCmmnHistoryEventProducer;
import io.orqueio.bpm.engine.impl.history.producer.CacheAwareHistoryEventProducer;
import io.orqueio.bpm.engine.impl.history.producer.CmmnHistoryEventProducer;
import io.orqueio.bpm.engine.impl.history.producer.DefaultDmnHistoryEventProducer;
...
import io.orqueio.bpm.engine.impl.history.transformer.CmmnHistoryTransformListener;
...
import io.orqueio.bpm.engine.impl.incident.CompositeIncidentHandler;
import io.orqueio.bpm.engine.impl.incident.DefaultIncidentHandler;
import io.orqueio.bpm.engine.impl.incident.IncidentHandler;
...
import io.orqueio.bpm.engine.impl.interceptor.CommandExecutorImpl;
...
import io.orqueio.bpm.engine.impl.interceptor.ExceptionCodeInterceptor;
...
import io.orqueio.bpm.engine.impl.jobexecutor.FailedJobCommandFactory;
...
import io.orqueio.bpm.engine.impl.jobexecutor.ProcessEventJobHandler;
import io.orqueio.bpm.engine.impl.jobexecutor.RejectedJobsHandler;
import io.orqueio.bpm.engine.impl.jobexecutor.TimerActivateJobDefinitionHandler;
import io.orqueio.bpm.engine.impl.jobexecutor.TimerActivateProcessDefinitionHandler;
...
import io.orqueio.bpm.engine.impl.jobexecutor.TimerSuspendProcessDefinitionHandler;
...
import io.orqueio.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupBatch;
import io.orqueio.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHandler;
...
import io.orqueio.bpm.engine.impl.metrics.MetricsReporterIdProvider;
import io.orqueio.bpm.engine.impl.metrics.parser.MetricsBpmnParseListener;
import io.orqueio.bpm.engine.impl.metrics.parser.MetricsCmmnTransformListener;
import io.orqueio.bpm.engine.impl.metrics.reporter.DbMetricsReporter;
import io.orqueio.bpm.engine.impl.migration.DefaultMigrationActivityMatcher;
import io.orqueio.bpm.engine.impl.migration.DefaultMigrationInstructionGenerator;
import io.orqueio.bpm.engine.impl.migration.MigrationActivityMatcher;
import io.orqueio.bpm.engine.impl.migration.MigrationInstructionGenerator;
import io.orqueio.bpm.engine.impl.migration.batch.MigrationBatchJobHandler;
import io.orqueio.bpm.engine.impl.migration.validation.activity.MigrationActivityValidator;
import io.orqueio.bpm.engine.impl.migration.validation.activity.NoCompensationHandlerActivityValidator;
import io.orqueio.bpm.engine.impl.migration.validation.activity.SupportedActivityValidator;
import io.orqueio.bpm.engine.impl.migration.validation.activity.SupportedPassiveEventTriggerActivityValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instance.AsyncAfterMigrationValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instance.AsyncMigrationValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instance.AsyncProcessStartMigrationValidator;
...
import io.orqueio.bpm.engine.impl.migration.validation.instance.NoUnmappedCompensationStartEventValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instance.NoUnmappedLeafInstanceValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instance.SupportedActivityInstanceValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instance.VariableConflictActivityInstanceValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instruction.AdditionalFlowScopeInstructionValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceBodyValidator;
...
import io.orqueio.bpm.engine.impl.migration.validation.instruction.ConditionalEventUpdateEventTriggerValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instruction.GatewayMappingValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instruction.MigrationInstructionValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instruction.OnlyOnceMappedActivityInstructionValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instruction.SameBehaviorInstructionValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instruction.SameEventScopeInstructionValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instruction.SameEventTypeValidator;
import io.orqueio.bpm.engine.impl.migration.validation.instruction.UpdateEventTriggersValidator;
import io.orqueio.bpm.engine.impl.optimize.OptimizeManager;
import io.orqueio.bpm.engine.impl.persistence.GenericManagerFactory;
import io.orqueio.bpm.engine.impl.persistence.deploy.Deployer;
import io.orqueio.bpm.engine.impl.persistence.deploy.cache.CacheFactory;
import io.orqueio.bpm.engine.impl.persistence.deploy.cache.DefaultCacheFactory;
...
import io.orqueio.bpm.engine.impl.persistence.entity.CommentManager;
...
import io.orqueio.bpm.engine.impl.persistence.entity.ExternalTaskManager;
import io.orqueio.bpm.engine.impl.persistence.entity.FilterManager;
...
import io.orqueio.bpm.engine.impl.persistence.entity.HistoricStatisticsManager;
...
import io.orqueio.bpm.engine.impl.persistence.entity.IncidentManager;
...
import io.orqueio.bpm.engine.impl.persistence.entity.MeterLogManager;
...
import io.orqueio.bpm.engine.impl.persistence.entity.SchemaLogManager;
import io.orqueio.bpm.engine.impl.persistence.entity.StatisticsManager;
import io.orqueio.bpm.engine.impl.persistence.entity.TableDataManager;
...
import io.orqueio.bpm.engine.impl.repository.DefaultDeploymentHandlerFactory;
import io.orqueio.bpm.engine.impl.runtime.ConditionHandler;
import io.orqueio.bpm.engine.impl.runtime.CorrelationHandler;
import io.orqueio.bpm.engine.impl.runtime.DefaultConditionHandler;
import io.orqueio.bpm.engine.impl.runtime.DefaultCorrelationHandler;
...
import io.orqueio.bpm.engine.impl.scripting.engine.VariableScopeResolverFactory;
...
import io.orqueio.bpm.engine.impl.telemetry.dto.DatabaseImpl;
import io.orqueio.bpm.engine.impl.telemetry.dto.InternalsImpl;
import io.orqueio.bpm.engine.impl.telemetry.dto.JdkImpl;
import io.orqueio.bpm.engine.impl.telemetry.dto.ProductImpl;
...
import io.orqueio.bpm.engine.impl.variable.ValueTypeResolverImpl;
import io.orqueio.bpm.engine.impl.variable.serializer.BooleanValueSerializer;
import io.orqueio.bpm.engine.impl.variable.serializer.ByteArrayValueSerializer;
import io.orqueio.bpm.engine.impl.variable.serializer.DateValueSerializer;
import io.orqueio.bpm.engine.impl.variable.serializer.DefaultVariableSerializers;
import io.orqueio.bpm.engine.impl.variable.serializer.DoubleValueSerializer;
import io.orqueio.bpm.engine.impl.variable.serializer.FileValueSerializer;
import io.orqueio.bpm.engine.impl.variable.serializer.IntegerValueSerializer;
import io.orqueio.bpm.engine.impl.variable.serializer.JavaObjectSerializer;
import io.orqueio.bpm.engine.impl.variable.serializer.LongValueSerlializer;
import io.orqueio.bpm.engine.impl.variable.serializer.NullValueSerializer;
import io.orqueio.bpm.engine.impl.variable.serializer.ShortValueSerializer;
import io.orqueio.bpm.engine.impl.variable.serializer.StringValueSerializer;
...
import io.orqueio.bpm.engine.runtime.WhitelistingDeserializationTypeValidator;
import io.orqueio.bpm.engine.task.TaskQuery;
import io.orqueio.bpm.engine.test.mock.MocksResolverFactory;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
  ...
  /**
   * As an instance of {@link io.orqueio.bpm.engine.impl.history.handler.CompositeHistoryEventHandler}
    ...
    synchronized (ProcessEngineConfigurationImpl.class) {
      ...
      if (sqlSessionFactory == null) {
        ...
        try {
          ...
          if (isUseSharedSqlSessionFactory) {
            properties.put("prefix", "${@io.orqueio.bpm.engine.impl.context.Context@getProcessEngineConfiguration().databaseTablePrefix}");
          } else {
