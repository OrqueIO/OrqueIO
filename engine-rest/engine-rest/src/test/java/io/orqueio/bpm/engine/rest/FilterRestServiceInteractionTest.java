...
import static io.orqueio.bpm.engine.rest.dto.AbstractQueryDto.SORT_ORDER_ASC_VALUE;
import static io.orqueio.bpm.engine.rest.dto.AbstractQueryDto.SORT_ORDER_DESC_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_ASSIGNEE_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_CASE_EXECUTION_ID_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_CASE_EXECUTION_VARIABLE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_CASE_INSTANCE_ID_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_CASE_INSTANCE_VARIABLE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_CREATE_TIME_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_DESCRIPTION_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_DUE_DATE_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_EXECUTION_ID_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_EXECUTION_VARIABLE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_FOLLOW_UP_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_ID_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_NAME_CASE_INSENSITIVE_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_NAME_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_PRIORITY_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_PROCESS_INSTANCE_ID_VALUE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_PROCESS_VARIABLE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_TASK_VARIABLE;
import static io.orqueio.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_TENANT_ID_VALUE;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_FILTER_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.mockFilter;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.mockVariableInstance;
import static io.orqueio.bpm.engine.rest.helper.TaskQueryMatcher.hasName;
...
import io.orqueio.bpm.engine.rest.helper.MockTaskBuilder;
