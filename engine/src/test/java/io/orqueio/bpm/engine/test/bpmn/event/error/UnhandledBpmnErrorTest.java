...
public class UnhandledBpmnErrorTest {
  ...
  public void testThrownInJavaDelegate() {
    ...
    BpmnModelInstance instance = Bpmn.createExecutableProcess("process")
        .startEvent()
        .serviceTask().orqueioClass(ThrowBpmnErrorDelegate.class)
        .endEvent().done();
  ...
  @Deployment(resources = {
      "io/orqueio/bpm/engine/test/bpmn/event/error/UnhandledBpmnErrorTest.testUncaughtErrorOnCallActivity.bpmn20.xml",
      "io/orqueio/bpm/engine/test/bpmn/event/error/UnhandledBpmnErrorTest.subprocess.bpmn20.xml" })
