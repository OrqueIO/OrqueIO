...
import io.orqueio.bpm.engine.impl.bpmn.behavior.BoundaryConditionalEventActivityBehavior;
...
import io.orqueio.bpm.engine.impl.bpmn.behavior.CallableElementActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.CancelBoundaryEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.CancelEndEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.CaseCallActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ClassDelegateActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.CompensationEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.DmnBusinessRuleTaskActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ErrorEndEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.EventBasedGatewayActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.EventSubProcessActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.EventSubProcessStartConditionalEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.EventSubProcessStartEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ExclusiveGatewayActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.InclusiveGatewayActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.IntermediateCatchEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.IntermediateCatchLinkEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.IntermediateConditionalEventBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.IntermediateThrowNoneEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.MailActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ManualTaskActivityBehavior;
...
import io.orqueio.bpm.engine.impl.bpmn.behavior.ParallelGatewayActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ParallelMultiInstanceActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ReceiveTaskActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ScriptTaskActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.SequentialMultiInstanceActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ServiceTaskDelegateExpressionActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ServiceTaskExpressionActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ShellActivityBehavior;
...
import io.orqueio.bpm.engine.impl.bpmn.behavior.TerminateEndEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ThrowEscalationEventActivityBehavior;
import io.orqueio.bpm.engine.impl.bpmn.behavior.ThrowSignalEventActivityBehavior;
...
import io.orqueio.bpm.engine.impl.bpmn.listener.ClassDelegateExecutionListener;
import io.orqueio.bpm.engine.impl.bpmn.listener.DelegateExpressionExecutionListener;
import io.orqueio.bpm.engine.impl.bpmn.listener.ExpressionExecutionListener;
import io.orqueio.bpm.engine.impl.bpmn.listener.ScriptExecutionListener;
...
import io.orqueio.bpm.engine.impl.el.UelExpressionCondition;
...
import io.orqueio.bpm.engine.impl.form.handler.DelegateTaskFormHandler;
import io.orqueio.bpm.engine.impl.form.handler.StartFormHandler;
import io.orqueio.bpm.engine.impl.form.handler.TaskFormHandler;
import io.orqueio.bpm.engine.impl.jobexecutor.AsyncAfterMessageJobDeclaration;
import io.orqueio.bpm.engine.impl.jobexecutor.AsyncBeforeMessageJobDeclaration;
import io.orqueio.bpm.engine.impl.jobexecutor.EventSubscriptionJobDeclaration;
...
import io.orqueio.bpm.engine.impl.jobexecutor.TimerDeclarationType;
import io.orqueio.bpm.engine.impl.jobexecutor.TimerEventJobHandler;
...
import io.orqueio.bpm.engine.impl.pvm.process.HasDIBounds;
import io.orqueio.bpm.engine.impl.pvm.process.Lane;
import io.orqueio.bpm.engine.impl.pvm.process.LaneSet;
import io.orqueio.bpm.engine.impl.pvm.process.ParticipantProcess;
...
import io.orqueio.bpm.engine.impl.scripting.ScriptCondition;
...
import io.orqueio.bpm.engine.impl.util.DecisionEvaluationUtil;
...
import io.orqueio.bpm.engine.impl.util.xml.Namespace;
import io.orqueio.bpm.engine.impl.util.xml.Parse;
import io.orqueio.bpm.engine.impl.variable.VariableDeclaration;
...
public class BpmnParse extends Parse {
  ...
  protected XMLImporter getImporter(String importType, Element theImport) {
    if (this.importers.containsKey(importType)) {
      ...
      if (importType.equals("http://schemas.xmlsoap.org/wsdl/")) {
        ...
        try {
          wsdlImporterClass = Class.forName("io.orqueio.bpm.engine.impl.webservice.CxfWSDLImporter", true, Thread.currentThread().getContextClassLoader());
  ...
  public ActivityImpl parseReceiveTask(Element receiveTaskElement, ScopeImpl scope) {
    ...
    // please check https://app.orqueio.com/jira/browse/CAM-10989
