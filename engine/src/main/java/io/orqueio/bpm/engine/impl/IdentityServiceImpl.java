...
import io.orqueio.bpm.engine.impl.cmd.CheckPassword;
import io.orqueio.bpm.engine.impl.cmd.GetPasswordPolicyCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateGroupCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateGroupQueryCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateMembershipCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateNativeUserQueryCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateTenantCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateTenantGroupMembershipCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateTenantQueryCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateTenantUserMembershipCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateUserCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateUserQueryCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteGroupCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteMembershipCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteTenantCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteTenantGroupMembershipCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteTenantUserMembershipCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteUserCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteUserInfoCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteUserPictureCmd;
import io.orqueio.bpm.engine.impl.cmd.GetUserAccountCmd;
import io.orqueio.bpm.engine.impl.cmd.GetUserInfoCmd;
import io.orqueio.bpm.engine.impl.cmd.GetUserInfoKeysCmd;
import io.orqueio.bpm.engine.impl.cmd.GetUserPictureCmd;
import io.orqueio.bpm.engine.impl.cmd.IsIdentityServiceReadOnlyCmd;
import io.orqueio.bpm.engine.impl.cmd.SaveGroupCmd;
import io.orqueio.bpm.engine.impl.cmd.SaveTenantCmd;
import io.orqueio.bpm.engine.impl.cmd.SaveUserCmd;
import io.orqueio.bpm.engine.impl.cmd.SetUserInfoCmd;
import io.orqueio.bpm.engine.impl.cmd.SetUserPictureCmd;
import io.orqueio.bpm.engine.impl.cmd.UnlockUserCmd;
import io.orqueio.bpm.engine.impl.identity.Account;
import io.orqueio.bpm.engine.impl.identity.Authentication;
import io.orqueio.bpm.engine.impl.identity.PasswordPolicyResultImpl;
