 ...
 * </p>
 */
public class OrqueioBpmNestedRuntimeException extends NestedRuntimeException {
   ...
   */
  public OrqueioBpmNestedRuntimeException(final String msg) {
    super(msg);
  }
   ...
   */
  public OrqueioBpmNestedRuntimeException(final String msg, final Throwable cause) {
    super(msg, cause);
  }
