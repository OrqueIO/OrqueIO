...
import static io.orqueio.bpm.engine.query.PeriodUnit.MONTH;
import static io.orqueio.bpm.engine.query.PeriodUnit.QUARTER;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_END_TIME;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_AVG;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_MAX;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_MIN;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_PERIOD;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_END_TIME;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_START_TIME;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_COUNT;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_DEFINITION;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_PROC_DEFINITION;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_PROC_DEF_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_PROC_DEF_NAME;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_TASK_NAME;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_START_TIME;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.createMockHistoricTaskInstanceDurationReport;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.createMockHistoricTaskInstanceReport;
import static io.orqueio.bpm.engine.rest.helper.MockProvider.createMockHistoricTaskInstanceReportWithProcDef;
