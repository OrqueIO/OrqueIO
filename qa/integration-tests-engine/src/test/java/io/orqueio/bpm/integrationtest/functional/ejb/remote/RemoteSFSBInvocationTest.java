...
import io.orqueio.bpm.integrationtest.functional.ejb.remote.bean.RemoteSFSBClientDelegateBean;
import io.orqueio.bpm.integrationtest.functional.ejb.remote.bean.RemoteSFSBean;
...
public class RemoteSFSBInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("io/orqueio/bpm/integrationtest/functional/ejb/remote/RemoteSFSBInvocationTest.testInvokeBean.bpmn20.xml");
  }
