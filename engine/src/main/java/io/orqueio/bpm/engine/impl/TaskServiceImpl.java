...
import io.orqueio.bpm.engine.impl.cmd.AddCommentCmd;
import io.orqueio.bpm.engine.impl.cmd.AddGroupIdentityLinkCmd;
import io.orqueio.bpm.engine.impl.cmd.AddUserIdentityLinkCmd;
import io.orqueio.bpm.engine.impl.cmd.AssignTaskCmd;
import io.orqueio.bpm.engine.impl.cmd.ClaimTaskCmd;
import io.orqueio.bpm.engine.impl.cmd.CompleteTaskCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateAttachmentCmd;
import io.orqueio.bpm.engine.impl.cmd.CreateTaskCmd;
import io.orqueio.bpm.engine.impl.cmd.DelegateTaskCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteAttachmentCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteGroupIdentityLinkCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteProcessInstanceCommentCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteTaskCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteTaskCommentCmd;
import io.orqueio.bpm.engine.impl.cmd.DeleteUserIdentityLinkCmd;
import io.orqueio.bpm.engine.impl.cmd.GetAttachmentCmd;
import io.orqueio.bpm.engine.impl.cmd.GetAttachmentContentCmd;
import io.orqueio.bpm.engine.impl.cmd.GetIdentityLinksForTaskCmd;
import io.orqueio.bpm.engine.impl.cmd.GetProcessInstanceAttachmentsCmd;
import io.orqueio.bpm.engine.impl.cmd.GetProcessInstanceCommentsCmd;
import io.orqueio.bpm.engine.impl.cmd.GetSubTasksCmd;
import io.orqueio.bpm.engine.impl.cmd.GetTaskAttachmentCmd;
import io.orqueio.bpm.engine.impl.cmd.GetTaskAttachmentContentCmd;
import io.orqueio.bpm.engine.impl.cmd.GetTaskAttachmentsCmd;
import io.orqueio.bpm.engine.impl.cmd.GetTaskCommentCmd;
import io.orqueio.bpm.engine.impl.cmd.GetTaskCommentsCmd;
import io.orqueio.bpm.engine.impl.cmd.GetTaskEventsCmd;
import io.orqueio.bpm.engine.impl.cmd.GetTaskVariableCmd;
import io.orqueio.bpm.engine.impl.cmd.GetTaskVariableCmdTyped;
import io.orqueio.bpm.engine.impl.cmd.GetTaskVariablesCmd;
import io.orqueio.bpm.engine.impl.cmd.HandleTaskBpmnErrorCmd;
import io.orqueio.bpm.engine.impl.cmd.HandleTaskEscalationCmd;
import io.orqueio.bpm.engine.impl.cmd.PatchTaskVariablesCmd;
import io.orqueio.bpm.engine.impl.cmd.RemoveTaskVariablesCmd;
import io.orqueio.bpm.engine.impl.cmd.ResolveTaskCmd;
import io.orqueio.bpm.engine.impl.cmd.SaveAttachmentCmd;
import io.orqueio.bpm.engine.impl.cmd.SaveTaskCmd;
import io.orqueio.bpm.engine.impl.cmd.SetTaskDescriptionCmd;
import io.orqueio.bpm.engine.impl.cmd.SetTaskDueDateCmd;
import io.orqueio.bpm.engine.impl.cmd.SetTaskFollowUpDateCmd;
import io.orqueio.bpm.engine.impl.cmd.SetTaskNameCmd;
import io.orqueio.bpm.engine.impl.cmd.SetTaskOwnerCmd;
import io.orqueio.bpm.engine.impl.cmd.SetTaskPriorityCmd;
import io.orqueio.bpm.engine.impl.cmd.SetTaskVariablesCmd;
import io.orqueio.bpm.engine.impl.cmd.UpdateCommentCmd;
