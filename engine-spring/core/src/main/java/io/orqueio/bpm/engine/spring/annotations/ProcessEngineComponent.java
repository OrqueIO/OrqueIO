 ...
 */
package io.orqueio.bpm.engine.spring.annotations;
 ...
 * that is so annotated to respond to events ("states") in a OrqueIO process.
 * Generically, it is a class that has been adapted to be usable in a OrqueIO process.
 *
 * <p/>
 ...
 * </code>
 * <p/>
 * This is a state that will be entered from OrqueIO and execution will flow through to the bean
 ...
 * tasked with responding to a state. If applied to a bean and there are no {@link io.orqueio.bpm.engine.annotations.ProcessEngineComponent}
