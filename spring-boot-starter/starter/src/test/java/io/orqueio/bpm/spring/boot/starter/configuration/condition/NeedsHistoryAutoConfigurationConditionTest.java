 ...
 */
package io.orqueio.bpm.spring.boot.starter.configuration.condition;
...
public class NeedsHistoryAutoConfigurationConditionTest {
  ...
  public void needsNoAdditionalConfigurationTest2() {
    ...
    Environment environment = mock(Environment.class);
    when(context.getEnvironment()).thenReturn(environment);
    when(environment.getProperty("orqueio.bpm.history-level")).thenReturn(NeedsHistoryAutoConfigurationCondition.HISTORY_AUTO);
