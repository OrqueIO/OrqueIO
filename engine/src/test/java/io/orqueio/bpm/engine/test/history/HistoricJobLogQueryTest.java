...
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByActivityId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByDeploymentId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByExecutionId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByJobDefinitionId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByJobDueDate;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByJobId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByJobPriority;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByJobRetries;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByProcessDefinitionId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByProcessDefinitionKey;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByProcessInstanceId;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogByTimestamp;
import static io.orqueio.bpm.engine.test.api.runtime.TestOrderingUtil.historicJobLogPartiallyByOccurence;
...
import io.orqueio.bpm.engine.test.api.runtime.FailingDelegate;
