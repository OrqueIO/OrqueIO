...
public class OrqueioBpmConfigurationTest {

  @Test
  public void processEngineConfigurationImplTest() {
    OrqueioBpmConfiguration orqueioBpmConfiguration = new OrqueioBpmConfiguration();
    List<ProcessEnginePlugin> processEnginePlugins = createUnordedList();
    ProcessEngineConfigurationImpl processEngineConfigurationImpl = orqueioBpmConfiguration.processEngineConfigurationImpl(processEnginePlugins);
