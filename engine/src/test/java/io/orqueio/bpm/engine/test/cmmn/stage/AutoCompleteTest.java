 ...
 */
package io.orqueio.bpm.engine.test.cmmn.stage;
...
public class AutoCompleteTest extends CmmnTest {
  ...
  @Deployment(resources = {"io/orqueio/bpm/engine/test/cmmn/stage/AutoCompleteTest.testRequiredEnabled.cmmn"})
  @Test
  ...
  @Deployment(resources = {
    "io/orqueio/bpm/engine/test/cmmn/stage/AutoCompleteTest.testProcessTasksOnStage.cmmn",
    "io/orqueio/bpm/engine/test/cmmn/stage/AutoCompleteTest.testProcessTasksOnStage.bpmn"
  })
