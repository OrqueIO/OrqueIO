...
/**
 * The set of built-in {@link Permission Permissions} for Orqueio Platform.
 *
 * @author Daniel Meyer
 *
 */
public enum Permissions implements Permission {
   ...
   *
   * <p>There is no built-in functionality of Orqueio Platform that uses the permission together
