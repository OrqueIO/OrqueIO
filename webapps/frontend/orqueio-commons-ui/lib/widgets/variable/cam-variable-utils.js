...
var angular = require('orqueio-bpm-sdk-js/vendor/angular'),
  typeUtils = require('orqueio-bpm-sdk-js/lib/forms/type-util'),
  templateDialog = require('./cam-widget-variable-dialog.html?raw'),
  templateStringDialog = require('./cam-widget-string-dialog.html?raw');

var varUtils = {};

function orqueioFormattedDate(date) {
  date = date || new Date();
  return date.toISOString().slice(0, -5);
}
varUtils.orqueioFormattedDate = orqueioFormattedDate;
