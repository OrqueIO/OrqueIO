...
public class CaseServiceCaseTaskTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
      "io/orqueio/bpm/engine/test/api/cmmn/oneCaseTaskAndOneHumanTaskCaseWithManualActivation.cmmn",
      "io/orqueio/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
      })
  @Test
  ...
  @Deployment(resources={"io/orqueio/bpm/engine/test/api/cmmn/oneCaseTaskAndOneHumanTaskCaseWithManualActivation.cmmn"})
  @Test
