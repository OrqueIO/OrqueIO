...
/**
 * The BPMN property orqueio extension element
 *
 * @author Sebastian Menski
 */
public class OrqueioPropertyImpl extends BpmnModelElementInstanceImpl implements OrqueioProperty {

  protected static Attribute<String> orqueioIdAttribute;
  protected static Attribute<String> orqueioNameAttribute;
  protected static Attribute<String> orqueioValueAttribute;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(OrqueioProperty.class, CAMUNDA_ELEMENT_PROPERTY)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<OrqueioProperty>() {
        public OrqueioProperty newInstance(ModelTypeInstanceContext instanceContext) {
          return new OrqueioPropertyImpl(instanceContext);
        }
      });
    ...
    orqueioValueAttribute = typeBuilder.stringAttribute(CAMUNDA_ATTRIBUTE_VALUE)
      .namespace(CAMUNDA_NS)
      .build();
  ...
  public OrqueioPropertyImpl(ModelTypeInstanceContext instanceContext) {
  ...
  public String getOrqueioValue() {
    return orqueioValueAttribute.getValue(this);
  }

  public void setOrqueioValue(String orqueioValue) {
    orqueioValueAttribute.setValue(this, orqueioValue);
  }
}
