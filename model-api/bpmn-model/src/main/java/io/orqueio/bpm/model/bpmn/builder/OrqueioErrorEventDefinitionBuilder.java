...
public class OrqueioErrorEventDefinitionBuilder extends AbstractErrorEventDefinitionBuilder<OrqueioErrorEventDefinitionBuilder> {

  public OrqueioErrorEventDefinitionBuilder(BpmnModelInstance modelInstance, ErrorEventDefinition element) {
    super(modelInstance, element, OrqueioErrorEventDefinitionBuilder.class);
  }

  public OrqueioErrorEventDefinitionBuilder expression(String expression) {
