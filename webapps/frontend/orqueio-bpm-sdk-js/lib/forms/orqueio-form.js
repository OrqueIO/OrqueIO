 ...
 */
function OrqueioForm(options) {
  if (!options) {
    throw new Error('OrqueioForm need to be initialized with options.');
  }
  ...
  if (!this.formElement && !this.containerElement) {
    return done(
      new Error(
        "OrqueioForm needs to be initilized with either 'formElement' or 'containerElement'"
      )
    );
  }
  ...
  if (!this.formElement && !this.formUrl) {
    return done(
      new Error(
        "Orqueio form needs to be intialized with either 'formElement' or 'formUrl'"
      )
    );
  }
...
/**
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.initializeHandler = function(FieldHandler) {
  var self = this;
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.initialize = function(done) {
  done =
    done ||
    function(err) {
      if (err) throw err;
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.renderForm = function(formHtmlSource) {
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.initializeForm = function(done) {
  var self = this;
...
OrqueioForm.prototype.initializeFieldHandlers = function() {
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.initializeFormScripts = function() {
...
OrqueioForm.prototype.executeFormScripts = function() {
  for (var i = 0; i < this.scripts.length; i++) {
    this.executeFormScript(this.scripts[i]);
  }
};

OrqueioForm.prototype.executeFormScript = function(script) {
  /*eslint-disable */
  /* jshint unused: false */
  (function(camForm) {
 ...
 * something truthy.
 */
OrqueioForm.prototype.store = function(callback) {
 ...
 */
OrqueioForm.prototype.isRestorable = function() {
  var formId = this.taskId || this.processDefinitionId || this.caseInstanceId;
 ...
 * something truthy.
 */
OrqueioForm.prototype.restore = function(callback) {
  var stored;
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.submit = function(callback) {
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.error = function(errorCode, errorMessage, callback) {
  var formId = this.taskId || this.processDefinitionId;
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.escalate = function(escalationCode, callback) {
  var formId = this.taskId || this.processDefinitionId;
...
OrqueioForm.prototype.transformFiles = function(callback) {
  var that = this;
  var counter = 1;
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.fetchVariables = function(done) {
  done = done || function() {};
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.parseVariables = function() {
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.submitVariables = function(done) {
  done = done || function() {};
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.storeOriginalValues = function(variables) {
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.mergeVariables = function(variables) {
  var vars = this.variableManager.variables;
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.applyVariables = function() {
  for (var i in this.fields) {
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.retrieveVariables = function() {
  for (var i in this.fields) {
 ...
 * @memberof CamSDK.form.OrqueioForm.prototype
 */
OrqueioForm.prototype.fireEvent = function(eventName, obj) {
  this.trigger(eventName, obj);
};

/**
 * @memberof CamSDK.form.OrqueioForm
 */
OrqueioForm.$ = $;

OrqueioForm.VariableManager = VariableManager;
OrqueioForm.fields = {};
OrqueioForm.fields.InputFieldHandler = InputFieldHandler;
OrqueioForm.fields.ChoicesFieldHandler = ChoicesFieldHandler;

/**
 * @memberof CamSDK.form.OrqueioForm
 */
OrqueioForm.cleanLocalStorage = function(timestamp) {
 ...
 * @type {Function}
 */
OrqueioForm.extend = BaseClass.extend;

module.exports = OrqueioForm;
