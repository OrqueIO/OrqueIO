...
Common frontend / UI resources, widgets and libraries for the [Orqueio web application][webapp]:
...
Widgets are reusable components which should be easy to integrate in the [Orqueio webapp][webapp] and your own projects.
...
```
vim /orqueio-commons-ui/node_modules/protractor/bin/webdriver-manager
```
Run chrome update for protractor
```
orqueio-commons-ui/node_modules/protractor/bin/webdriver-manager --chrome update
```
...
[webapp]: https://github.com/orqueio/orqueio-bpm-platform/tree/master/webapps
