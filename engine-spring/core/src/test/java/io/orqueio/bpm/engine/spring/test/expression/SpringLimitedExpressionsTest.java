 ...
 */
package io.orqueio.bpm.engine.spring.test.expression;
 ...
 */
@ContextConfiguration("classpath:io/orqueio/bpm/engine/spring/test/expression/expressionLimitedBeans-context.xml")
