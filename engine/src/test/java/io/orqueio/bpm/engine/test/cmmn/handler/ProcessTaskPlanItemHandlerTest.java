...
import io.orqueio.bpm.engine.impl.cmmn.behavior.ProcessTaskActivityBehavior;
import io.orqueio.bpm.engine.impl.cmmn.handler.CasePlanModelHandler;
import io.orqueio.bpm.engine.impl.cmmn.handler.ProcessTaskItemHandler;
...
public class ProcessTaskPlanItemHandlerTest extends CmmnElementHandlerTest {
  ...
  public void testBinding() {
    ...
    processTask.setOrqueioProcessBinding(processBinding.getValue());
  ...
  public void testVersionConstant() {
    ...
    processTask.setOrqueioProcessVersion(processVersion);
