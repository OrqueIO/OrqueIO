...
public class OrqueioEventingIT extends AbstractOrqueioAutoConfigurationIT {
  ...
  public final void shouldNotInvokeHandlerOnModificationWhenSkippingCustomListeners() {
    ...
    // then
    assertThat(eventCaptor.executionEvents).isEmpty();
//    assertThat(eventCaptor.taskEvents).isEmpty(); => https://github.com/orqueio/orqueio-bpm-platform/issues/3103
  }
