 ...
 */
package io.orqueio.bpm.engine.spring.test.servicetask;
 ...
 * @author Falko Menge
 */
@ContextConfiguration("classpath:io/orqueio/bpm/engine/spring/test/servicetask/serviceraskSpringTestCatchError-context.xml")
