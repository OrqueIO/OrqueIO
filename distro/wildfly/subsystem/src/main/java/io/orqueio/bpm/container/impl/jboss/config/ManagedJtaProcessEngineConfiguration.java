...
import io.orqueio.bpm.engine.impl.cfg.JakartaTransactionProcessEngineConfiguration;
...
public class ManagedJtaProcessEngineConfiguration extends JakartaTransactionProcessEngineConfiguration {
  ...
  protected void initTelemetryData() {
    ...
    Set<String> orqueioIntegration = telemetryData.getProduct().getInternals().getCamundaIntegration();
    orqueioIntegration.add(CamundaIntegration.WILDFLY_SUBSYSTEM);
  }
