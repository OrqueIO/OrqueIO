...
import io.orqueio.bpm.engine.test.bpmn.iomapping.VariableLogDelegate;
  ...
  protected static final BpmnModelInstance EVENT_GATEWAY_PROCESS =
    Bpmn.createExecutableProcess("process")
      ...
      .intermediateCatchEvent("conditionalEvent")
        .orqueioOutputParameter("eventOutput", "foo")
        .conditionalEventDefinition()
        .condition("${moveOn}")
        .conditionalEventDefinitionDone()
      .serviceTask("inputParameterTask")
        .orqueioInputParameter("variable1", "testValue")
        .orqueioClass(VariableLogDelegate.class)
      .endEvent()
      .done();
