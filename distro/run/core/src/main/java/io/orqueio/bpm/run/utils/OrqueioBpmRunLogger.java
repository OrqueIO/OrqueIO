...
public class OrqueioBpmRunLogger extends BaseLogger {
  ...
  public static final OrqueioBpmRunLogger LOG = createLogger(OrqueioBpmRunLogger.class, PROJECT_CODE, PACKAGE, PROJECT_ID);

  public void processEnginePluginRegistered(String pluginClass) {
      logInfo("001",
              "The process engine plugin '{}' was registered with the " +
                  "Orqueio Run process engine.",
              pluginClass);
  }
