 ...
 */
package io.orqueio.bpm.integrationtest.functional.bpmnmodelapi;
...
public class RepositoryServiceBpmnModelRetrievalTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessApplication() {
    return initWebArchiveDeployment()
        .addAsResource(new StringAsset(Bpmn.convertToString(Bpmn.createExecutableProcess(TEST_PROCESS).orqueioHistoryTimeToLive(180).startEvent().done())), "testProcess.bpmn20.xml");
  }
