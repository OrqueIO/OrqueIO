...
public class MigrationContextSwitchClassesTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static final BpmnModelInstance subProcessProcess(String key) {
    return  Bpmn.createExecutableProcess(key)
      ...
      .startEvent()
      .subProcess()
      .orqueioExecutionListenerClass(ExecutionListener.EVENTNAME_START, InstantiationListener.class.getName())
      .orqueioExecutionListenerClass(ExecutionListener.EVENTNAME_END, RemovalListener.class.getName())
      .embeddedSubProcess()
        .startEvent()
        .userTask("userTask")
        .endEvent()
