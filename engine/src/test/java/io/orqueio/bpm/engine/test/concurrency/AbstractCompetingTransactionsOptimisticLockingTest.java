...
public abstract class AbstractCompetingTransactionsOptimisticLockingTest {
  ...
  @Deployment(resources = "io/orqueio/bpm/engine/test/concurrency/AbstractCompetingTransactionsOptimisticLockingTest.shouldDetectConcurrentDeletionOfExecutionForTaskInsert.bpmn20.xml")
  @Test
