...
public class OrqueioBpmSecurityAutoConfigOauth2ApplicationIT extends AbstractSpringSecurityIT {
  ...
  public void testSpringSecurityAutoConfigurationCorrectlySet() {
    ...
    assertThat(getBeanForClass(OrqueioSpringSecurityOAuth2AutoConfiguration.class, mockMvc.getDispatcherServlet().getWebApplicationContext())).isNotNull();
    assertThat(getBeanForClass(OrqueioBpmSpringSecurityDisableAutoConfiguration.class, mockMvc.getDispatcherServlet().getWebApplicationContext())).isNull();
  }
  ...
  public void testWebappWithoutAuthentication() throws Exception {
    ...
    // when
    mockMvc.perform(MockMvcRequestBuilders.get(baseUrl + "/orqueio/api/engine/engine/default/user")
