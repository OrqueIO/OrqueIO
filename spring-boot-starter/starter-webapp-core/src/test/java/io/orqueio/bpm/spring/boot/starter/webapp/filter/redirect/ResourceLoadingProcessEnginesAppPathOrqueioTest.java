 ...
 */
package io.orqueio.bpm.spring.boot.starter.webapp.filter.redirect;
...
@SpringBootTest(classes = { FilterTestApp.class},
    ...
    properties = {
        "camunda.bpm.webapp.application-path=/orqueio",
        "camunda.bpm.webapp.index-redirect-enabled=false",
        "camunda.bpm.admin-user.id=admin" })
@DirtiesContext
public class ResourceLoadingProcessEnginesAppPathOrqueioTest {
