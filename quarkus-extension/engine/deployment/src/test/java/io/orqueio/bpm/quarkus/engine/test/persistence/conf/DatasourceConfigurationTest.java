 ...
 */
package io.orqueio.bpm.quarkus.engine.test.persistence.conf;
...
public class DatasourceConfigurationTest {
  ...
  static QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .withConfigurationResource("io/orqueio/bpm/quarkus/engine/test/persistence/conf/override-default-datasource-application.properties")
