...
public class ProductPropertiesUtil {
  ...
  protected static final String PROPERTIES_FILE_PATH = "/io/orqueio/bpm/engine/product-info.properties";
  protected static final String VERSION_PROPERTY = "orqueio.version";
