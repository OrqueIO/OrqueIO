 ...
 */
package io.orqueio.bpm.engine.cdi.test.bpmn;
...
public class SignalEventTest extends CdiProcessEngineTestCase {
  ...
  @Test
  @Deployment(resources = {"io/orqueio/bpm/engine/cdi/test/bpmn/SignalEventTests.catchAlertSignalBoundaryWithReceiveTask.bpmn20.xml", 
                          "io/orqueio/bpm/engine/cdi/test/bpmn/SignalEventTests.throwAlertSignalWithDelegate.bpmn20.xml"})
