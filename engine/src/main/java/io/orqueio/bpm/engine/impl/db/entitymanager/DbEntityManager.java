...
import static io.orqueio.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_MERGED;
import static io.orqueio.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_PERSISTENT;
import static io.orqueio.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_TRANSIENT;
import static io.orqueio.bpm.engine.impl.db.entitymanager.cache.DbEntityState.MERGED;
import static io.orqueio.bpm.engine.impl.db.entitymanager.cache.DbEntityState.PERSISTENT;
import static io.orqueio.bpm.engine.impl.db.entitymanager.cache.DbEntityState.TRANSIENT;
import static io.orqueio.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE;
import static io.orqueio.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE_BULK;
import static io.orqueio.bpm.engine.impl.db.entitymanager.operation.DbOperationType.INSERT;
import static io.orqueio.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE;
import static io.orqueio.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE_BULK;
...
import io.orqueio.bpm.engine.impl.ExecutionQueryImpl;
...
import io.orqueio.bpm.engine.impl.db.EntityLoadListener;
...
import io.orqueio.bpm.engine.impl.db.entitymanager.operation.DbOperation.State;
import io.orqueio.bpm.engine.impl.db.entitymanager.operation.DbOperationManager;
import io.orqueio.bpm.engine.impl.db.entitymanager.operation.DbOperationType;
